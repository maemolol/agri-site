import {
  ...
  require_react_is,
  shift
} from "./chunk-TUOMPSSA.js";
import {
  require_dist
} from "./chunk-NNMHQ5QO.js";
import {
  CheckmarkIcon,
  ChevronDownIcon,
  ChevronRightIcon,
...
import {
  ...
  rt,
  st
} from "./chunk-U7IRH7NM.js";
import {
  require_react_dom
} from "./chunk-S5N5YNQJ.js";
import {
  require_jsx_runtime
} from "./chunk-LZWBL7GP.js";
import {
  require_react
} from "./chunk-2AQJYVA4.js";
import {
  __publicField,
  __toCommonJS,
  __toESM
...
function buildCardColorTheme(options, config) {
  ...
  return {
    ...
    code: {
      ...
      fg: resolveColorTokenValue(context2, (_e = tokens == null ? void 0 : tokens.code) == null ? void 0 : _e.fg)
    },
...
function buildShadowColorTheme(options, config) {
  ...
  return {
    ...
    penumbra: resolveColorTokenValue(context2, (_e = tokens == null ? void 0 : tokens.shadow) == null ? void 0 : _e.penumbra),
...
function buildButtonStateColorTheme(options, config) {
  ...
  const {
    ...
    scheme,
    state
  } = options, cardTokens = (_b = (_a = config == null ? void 0 : config.color) == null ? void 0 : _a.base) == null ? void 0 : _b[cardTone], tokens = (_f = (_e = (_d = (_c = config == null ? void 0 : config.color) == null ? void 0 : _c.button) == null ? void 0 : _d[mode]) == null ? void 0 : _e[tone]) == null ? void 0 : _f[state], hue = (tokens == null ? void 0 : tokens._hue) || (cardTokens == null ? void 0 : cardTokens._hue) || "gray", blendMode = (tokens == null ? void 0 : tokens._blend) || ["screen", "multiply"], context2 = {
    hue,
    scheme
  };
  return {
...
function buildInputStateColorTheme(options, config) {
  ...
  const {
    ...
    scheme,
    state
  } = options, cardTokens = (_b = (_a = config == null ? void 0 : config.color) == null ? void 0 : _a.base) == null ? void 0 : _b[cardTone], tokens = (_e = (_d = (_c = config == null ? void 0 : config.color) == null ? void 0 : _c.input) == null ? void 0 : _d[mode]) == null ? void 0 : _e[state], hue = (tokens == null ? void 0 : tokens._hue) || (cardTokens == null ? void 0 : cardTokens._hue) || "gray", blendMode = (tokens == null ? void 0 : tokens._blend) || ["screen", "multiply"], context2 = {
    hue,
    scheme
  };
  return {
...
function buildSelectableStateColorTheme(options, config) {
  ...
  const {
    ...
    state,
    tone
  } = options, cardTokens = (_b = (_a = config == null ? void 0 : config.color) == null ? void 0 : _a.base) == null ? void 0 : _b[cardTone], tokens = (_e = (_d = (_c = config == null ? void 0 : config.color) == null ? void 0 : _c.selectable) == null ? void 0 : _d[tone]) == null ? void 0 : _e[state], hue = (tokens == null ? void 0 : tokens._hue) || (cardTokens == null ? void 0 : cardTokens._hue) || "gray", blendMode = (tokens == null ? void 0 : tokens._blend) || ["screen", "multiply"], context2 = {
    hue,
    scheme
  };
  return {
...
function rgbToHex(color22) {
  const r = round(clamp(Math.round(color22.r), 0, 255)), g = round(clamp(Math.round(color22.g), 0, 255)), b = round(clamp(Math.round(color22.b), 0, 255));
  return "a" in color22 ? `rgba(${r},${g},${b},${color22.a})` : "#" + ((1 << 24) + (r << 16) + (g << 8) + b).toString(16).slice(1);
}
function rgbToHsl({
  r,
  g,
...
function hslToRgb(hsl) {
  const s = hsl.s / 100, l = hsl.l / 100, c3 = (1 - Math.abs(2 * l - 1)) * s, x = c3 * (1 - Math.abs(hsl.h / 60 % 2 - 1)), m2 = l - c3 / 2;
  let r = 0, g = 0, b = 0;
...
function renderColorValue(str, options) {
  ...
  try {
    if (hex2 = mixThemeColor(hex2, mixOptions), bg && node.mix !== void 0) {
      ...
      hex2 = rgbToHex(mix(from, to, node.mix));
    }
  } catch (err) {
    throw console.warn("could not blend", hex2, mixOptions), err;
  }
  return hex2 === "#aN" && (console.warn(`invalid color token value: ${str}`), hex2 = hexBeforeMix), node.opacity !== void 0 && (hex2 = rgba(hex2, node.opacity)), hex2;
}
...
var SubscriptionManager = class {
  ...
  notify(a, b, c3) {
    ...
    if (numSubscriptions === 1) {
      this.subscriptions[0](a, b, c3);
    } else {
      for (let i = 0; i < numSubscriptions; i++) {
        const handler = this.subscriptions[i];
        handler && handler(a, b, c3);
      }
    }
  }
  getSize() {
...
var splitColor = (aName, bName, cName) => (v) => {
  if (typeof v !== "string")
    return v;
  const [a, b, c3, alpha2] = v.match(floatRegex);
  return {
    [aName]: parseFloat(a),
    [bName]: parseFloat(b),
    [cName]: parseFloat(c3),
...
var color2 = {
  test: (v) => rgba2.test(v) || hex.test(v) || hsla.test(v),
  parse: (v) => {
    if (rgba2.test(v)) {
  ...
  transform: (v) => {
    return typeof v === "string" ? v : v.hasOwnProperty("red") ? rgba2.transform(v) : hsla.transform(v);
  },
  getAnimatableNone: (v) => {
...
function fillOffset(offset3, remaining) {
  ...
  for (let i = 1; i <= remaining; i++) {
    ...
    offset3.push(mixNumber(min, 1, offsetProgress));
  }
}
...
var cubicBezierAsString = ([a, b, c3, d]) => `cubic-bezier(${a}, ${b}, ${c3}, ${d})`;
...
function addSVGPathValue(element, state, key2, value) {
  ...
  if (key2 === "pathOffset") {
    return state.set(key2, value, () => {
      const offset3 = state.latest[key2];
      element.setAttribute("stroke-dashoffset", `${-offset3}`);
    });
  } else {
...
function convertAttrKey(key2) {
  return key2.replace(/^attr([A-Z])/, (_, firstChar) => firstChar.toLowerCase());
}
...
var PopChildMeasure = class extends React3.Component {
  getSnapshotBeforeUpdate(prevProps) {
    ...
    if (element && prevProps.isPresent && !this.props.isPresent && this.props.pop !== false) {
      ...
      size3.right = parentWidth - size3.width - size3.left;
      size3.bottom = parentHeight - size3.height - size3.top;
    }
    return null;
  }
  /**
...
function PopChild({ children, isPresent, anchorX, anchorY, root, pop }) {
  ...
  const size3 = (0, import_react7.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0,
  ...
  (0, import_react7.useInsertionEffect)(() => {
    const { width, height, top, left, right, bottom } = size3.current;
  ...
  return (0, import_jsx_runtime.jsx)(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size3, pop, children: pop === false ? children : React3.cloneElement(children, { ref: composedRef }) });
}
...
function useRender(Component4, props, ref, { latestValues }, isStatic, forwardMotionProps = false, isSVG) {
  ...
  const elementProps = Component4 !== import_react23.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
  const { children } = props;
  const renderedChildren = (0, import_react23.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
  return (0, import_react23.createElement)(Component4, {
    ...elementProps,
...
var makeUseVisualState = (config) => (props, isStatic) => {
  const context2 = (0, import_react24.useContext)(MotionContext);
...
function useVisualElement(Component4, visualState, props, createVisualElement, ProjectionNodeConstructor, isSVG) {
  ...
  const wantsHandoff = (0, import_react27.useRef)(Boolean(optimisedAppearId) && !((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
  useIsomorphicLayoutEffect(() => {
...
function createMotionComponent(Component4, { forwardMotionProps = false, type } = {}, preloadedFeatures, createVisualElement) {
  ...
  function MotionDOMComponent(props, externalRef) {
    ...
    if (!isStatic && isBrowser) {
      ...
      context2.visualElement = useVisualElement(Component4, visualState, configAndProps, createVisualElement, layoutProjection.ProjectionNode, isSVG);
    }
    return (0, import_jsx_runtime7.jsxs)(MotionContext.Provider, { value: context2, children: [MeasureLayout2 && context2.visualElement ? (0, import_jsx_runtime7.jsx)(MeasureLayout2, { visualElement: context2.visualElement, ...configAndProps }) : null, useRender(Component4, props, useMotionRef(visualState, context2.visualElement, externalRef), visualState, isStatic, forwardMotionProps, isSVG)] });
  }
...
var createDomVisualElement = (Component4, options) => {
  ...
  return isSVG ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component4 !== import_react29.Fragment
  });
};
...
function addKeyframes(sequence, keyframes2, easing, offset3, startTime, endTime) {
  ...
  for (let i = 0; i < keyframes2.length; i++) {
    sequence.push({
      value: keyframes2[i],
      at: mixNumber(startTime, endTime, offset3[i]),
...
function checkReorder(order, value, offset3, velocity) {
  if (!velocity)
    return order;
  ...
  const context2 = {
    ...
    updateOrder: (item, offset3, velocity) => {
      if (isReordering.current)
        return;
      const newOrder = checkReorder(order, item, offset3, velocity);
      if (order !== newOrder) {
...
function ReorderItemComponent({ children, style = {}, value, as = "li", onDrag, onDragEnd, layout: layout2 = true, ...props }, externalRef) {
  ...
  return (0, import_jsx_runtime11.jsx)(Component4, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style, x: point.x, y: point.y, zIndex }, layout: layout2, onDrag: (event, gesturePoint) => {
    ...
    const offset3 = point[axis].get();
    updateOrder(value, offset3, velocity[axis]);
...
function useArrayProp(val, defaultVal) {
  ...
  const [t1, setCache] = (0, import_react53.useState)(t0), [cachedVal, cachedHash] = t1, hash = JSON.stringify(val ?? defaultVal);
...
function useClickOutsideEvent(listener, t0, boundaryElement) {
  ...
  let t3;
  $[7] !== hasListener ? (t3 = [hasListener], $[7] = hasListener, $[8] = t3) : t3 = $[8], (0, import_react53.useEffect)(t2, t3), (0, import_react53.useDebugValue)(listener ? "MouseDown On" : "MouseDown Off");
}
function _temp$9() {
  return EMPTY_ARRAY;
}
function useCustomValidity(ref, customValidity) {
  ...
  }, t1 = [customValidity, ref], $[0] = customValidity, $[1] = ref, $[2] = t0, $[3] = t1) : (t0 = $[2], t1 = $[3]), (0, import_react53.useEffect)(t0, t1);
}
...
function useElementSize(element) {
  const $ = (0, import_react_compiler_runtime.c)(3), [size22, setSize] = (0, import_react53.useState)(null);
  let t0, t1;
  return $[0] !== element ? (t0 = () => {
    if (element)
      return _elementSizeObserver.subscribe(element, setSize);
  }, t1 = [element], $[0] = element, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), (0, import_react53.useEffect)(t0, t1), size22;
}
function useGlobalKeyDown(onKeyDown) {
  ...
  let t2;
  $[4] === Symbol.for("react.memo_cache_sentinel") ? (t2 = [], $[4] = t2) : t2 = $[4], (0, import_react53.useEffect)(t1, t2);
}
function useMatchMedia(mediaQueryString, getServerSnapshot2) {
  ...
  let t1;
  return $[2] !== mediaQueryString ? (t1 = () => window.matchMedia(mediaQueryString).matches, $[2] = mediaQueryString, $[3] = t1) : t1 = $[3], (0, import_react53.useSyncExternalStore)(t0, t1, getServerSnapshot2);
}
...
function ThemeProvider(props) {
  const $ = (0, import_react_compiler_runtime.c)(15), parentTheme = (0, import_react53.useContext)(ThemeContext), {
    children
  ...
  if (!theme) {
    let t22;
    return $[8] === Symbol.for("react.memo_cache_sentinel") ? (t22 = (0, import_jsx_runtime12.jsx)("pre", { children: 'ThemeProvider: no "theme" property provided' }), $[8] = t22) : t22 = $[8], t22;
  }
  let t2;
  $[9] !== children || $[10] !== theme ? (t2 = (0, import_jsx_runtime12.jsx)(rt, { theme, children }), $[9] = children, $[10] = theme, $[11] = t2) : t2 = $[11];
  let t3;
  return $[12] !== t2 || $[13] !== themeContext ? (t3 = (0, import_jsx_runtime12.jsx)(ThemeContext.Provider, { value: themeContext, children: t2 }), $[12] = t2, $[13] = themeContext, $[14] = t3) : t3 = $[14], t3;
}
...
function ThemeColorProvider(props) {
  ...
  let t1;
  return $[0] !== children || $[1] !== root.theme || $[2] !== t0 || $[3] !== tone ? (t1 = (0, import_jsx_runtime12.jsx)(ThemeProvider, { scheme: t0, theme: root.theme, tone, children }), $[0] = children, $[1] = root.theme, $[2] = t0, $[3] = tone, $[4] = t1) : t1 = $[4], t1;
}
...
function useTheme_v2() {
  const $ = (0, import_react_compiler_runtime.c)(2), t0 = st();
  let t1;
...
function responsiveInputPaddingStyle(props) {
  ...
  return _responsive(media, _padding, (_, i) => {
    const size22 = font.text.sizes[_fontSize[i]] || font.text.sizes[2], emSize = size22.lineHeight - size22.ascenderHeight - size22.descenderHeight, p = space[_padding[i]], s = space[_space[i]], styles = {
      paddingTop: rem(p - size22.ascenderHeight),
      paddingRight: rem(p),
      paddingBottom: rem(p - size22.descenderHeight),
      paddingLeft: rem(p)
    };
...
var StyledLabel = gt.div.withConfig({
...
var Label = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  if (textOverflow === "ellipsis") {
    let t22;
    $[9] !== children ? (t22 = (0, import_jsx_runtime12.jsx)(SpanWithTextOverflow, { children }), $[9] = children, $[10] = t22) : t22 = $[10], children = t22;
  } else {
    let t22;
    $[11] !== children ? (t22 = (0, import_jsx_runtime12.jsx)("span", { children }), $[11] = children, $[12] = t22) : t22 = $[12], children = t22;
  }
  const t2 = useArrayProp(align), t3 = useArrayProp(size22);
  let t4;
  return $[13] !== accent || $[14] !== children || $[15] !== muted || $[16] !== ref || $[17] !== restProps || $[18] !== t2 || $[19] !== t3 || $[20] !== weight ? (t4 = (0, import_jsx_runtime12.jsx)(StyledLabel, { "data-ui": "Label", ...restProps, $accent: accent, $align: t2, $muted: muted, $size: t3, $weight: weight, ref, children }), $[13] = accent, $[14] = children, $[15] = muted, $[16] = ref, $[17] = restProps, $[18] = t2, $[19] = t3, $[20] = weight, $[21] = t4) : t4 = $[21], t4;
});
...
var Avatar = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  }, t4 = [arrowPosition, arrowPositionProp], $[13] = arrowPosition, $[14] = arrowPositionProp, $[15] = t3, $[16] = t4) : (t3 = $[15], t4 = $[16]), (0, import_react53.useEffect)(t3, t4);
  let t5, t6;
  $[17] !== src ? (t5 = () => {
    src && setImageFailed(false);
  }, t6 = [src], $[17] = src, $[18] = t5, $[19] = t6) : (t5 = $[18], t6 = $[19]), (0, import_react53.useEffect)(t5, t6);
  let t7;
  ...
  let t8;
  $[22] !== size22 ? (t8 = size22.map(_temp$6), $[22] = size22, $[23] = t8) : t8 = $[23];
  const initialsSize = t8, t9 = typeof as == "string" ? as : void 0;
  let t10;
  $[24] !== color3 ? (t10 = (0, import_jsx_runtime12.jsx)(Arrow$1, { children: (0, import_jsx_runtime12.jsx)("svg", { width: "11", height: "7", viewBox: "0 0 11 7", fill: "none", children: (0, import_jsx_runtime12.jsx)("path", { d: "M6.67948 1.50115L11 7L0 7L4.32052 1.50115C4.92109 0.736796 6.07891 0.736795 6.67948 1.50115Z", fill: color3 }) }) }), $[24] = color3, $[25] = t10) : t10 = $[25];
  let t11;
  $[26] !== __unstable_hideInnerStroke || $[27] !== _radius || $[28] !== _sizeRem || $[29] !== handleImageError || $[30] !== imageFailed || $[31] !== imageId || $[32] !== src ? (t11 = !imageFailed && src && (0, import_jsx_runtime12.jsxs)(AvatarImage, { viewBox: `0 0 ${_sizeRem} ${_sizeRem}`, fill: "none", children: [
  ...
  let t12;
  $[34] !== imageFailed || $[35] !== initials || $[36] !== initialsSize || $[37] !== src ? (t12 = (imageFailed || !src) && initials && (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: (0, import_jsx_runtime12.jsx)(Initials, { children: (0, import_jsx_runtime12.jsx)(InitialsLabel, { forwardedAs: "span", size: initialsSize, weight: "medium", children: initials }) }) }), $[34] = imageFailed, $[35] = initials, $[36] = initialsSize, $[37] = src, $[38] = t12) : t12 = $[38];
  let t13;
  return $[39] !== arrowPosition || $[40] !== as || $[41] !== color3 || $[42] !== ref || $[43] !== restProps || $[44] !== size22 || $[45] !== status || $[46] !== t10 || $[47] !== t11 || $[48] !== t12 || $[49] !== t9 || $[50] !== title ? (t13 = (0, import_jsx_runtime12.jsxs)(StyledAvatar, { as, "data-as": t9, "data-ui": "Avatar", ...restProps, $color: color3, $size: size22, "aria-label": title, "data-arrow-position": arrowPosition, "data-status": status, ref, title, children: [
    t10,
    t11,
    t12
  ] }), $[39] = arrowPosition, $[40] = as, $[41] = color3, $[42] = ref, $[43] = restProps, $[44] = size22, $[45] = status, $[46] = t10, $[47] = t11, $[48] = t12, $[49] = t9, $[50] = title, $[51] = t13) : t13 = $[51], t13;
});
...
var StyledAvatarCounter = gt.div.withConfig({
...
var AvatarCounter = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t1;
  $[0] !== size22 ? (t1 = size22.map(_temp$5), $[0] = size22, $[1] = t1) : t1 = $[1];
  const fontSize2 = t1;
  let t2;
  $[2] !== count || $[3] !== fontSize2 ? (t2 = (0, import_jsx_runtime12.jsx)(Label, { as: "span", size: fontSize2, weight: "medium", children: count }), $[2] = count, $[3] = fontSize2, $[4] = t2) : t2 = $[4];
  let t3;
  return $[5] !== ref || $[6] !== size22 || $[7] !== t2 ? (t3 = (0, import_jsx_runtime12.jsx)(StyledAvatarCounter, { $size: size22, "data-ui": "AvatarCounter", ref, children: t2 }), $[5] = ref, $[6] = size22, $[7] = t2, $[8] = t3) : t3 = $[8], t3;
});
...
var StyledAvatarStack = gt.div.withConfig({
...
var AvatarStack = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t3;
  $[5] !== len || $[6] !== size22 ? (t3 = len === 0 && (0, import_jsx_runtime12.jsx)("div", { children: (0, import_jsx_runtime12.jsx)(AvatarCounter, { count: len, size: size22 }) }), $[5] = len, $[6] = size22, $[7] = t3) : t3 = $[7];
  let t4;
  $[8] !== extraCount || $[9] !== len || $[10] !== size22 ? (t4 = len !== 0 && extraCount > 1 && (0, import_jsx_runtime12.jsx)("div", { children: (0, import_jsx_runtime12.jsx)(AvatarCounter, { count: extraCount, size: size22 }) }), $[8] = extraCount, $[9] = len, $[10] = size22, $[11] = t4) : t4 = $[11];
  let t5;
  $[12] !== size22 ? (t5 = (child, childIndex) => (0, import_jsx_runtime12.jsx)("div", { children: (0, import_react53.cloneElement)(child, {
    size: size22
  }) }, String(childIndex)), $[12] = size22, $[13] = t5) : t5 = $[13];
  const t6 = visibleChildren.map(t5);
  let t7;
  return $[14] !== T0 || $[15] !== ref || $[16] !== restProps || $[17] !== size22 || $[18] !== t3 || $[19] !== t4 || $[20] !== t6 ? (t7 = (0, import_jsx_runtime12.jsxs)(T0, { "data-ui": t2, ...restProps, ref, $size: size22, children: [
    t3,
    t4,
    t6
  ] }), $[14] = T0, $[15] = ref, $[16] = restProps, $[17] = size22, $[18] = t3, $[19] = t4, $[20] = t6, $[21] = t7) : t7 = $[21], t7;
});
AvatarStack.displayName = "ForwardRef(AvatarStack)";
var StyledBox = gt.div.withConfig({
...
var Box = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t30;
  return $[28] !== asProp || $[29] !== props.children || $[30] !== ref || $[31] !== restProps || $[32] !== t10 || $[33] !== t11 || $[34] !== t12 || $[35] !== t13 || $[36] !== t14 || $[37] !== t15 || $[38] !== t16 || $[39] !== t17 || $[40] !== t18 || $[41] !== t19 || $[42] !== t20 || $[43] !== t21 || $[44] !== t22 || $[45] !== t23 || $[46] !== t24 || $[47] !== t25 || $[48] !== t26 || $[49] !== t27 || $[50] !== t28 || $[51] !== t29 || $[52] !== t4 || $[53] !== t5 || $[54] !== t6 || $[55] !== t7 || $[56] !== t8 || $[57] !== t9 ? (t30 = (0, import_jsx_runtime12.jsx)(StyledBox, { "data-as": t4, "data-ui": "Box", ...restProps, $column: t5, $columnStart: t6, $columnEnd: t7, $display: t8, $flex: t9, $height: t10, $margin: t11, $marginX: t12, $marginY: t13, $marginTop: t14, $marginRight: t15, $marginBottom: t16, $marginLeft: t17, $overflow: t18, $padding: t19, $paddingX: t20, $paddingY: t21, $paddingTop: t22, $paddingRight: t23, $paddingBottom: t24, $paddingLeft: t25, $row: t26, $rowStart: t27, $rowEnd: t28, $sizing: t29, as: asProp, ref, children: props.children }), $[28] = asProp, $[29] = props.children, $[30] = ref, $[31] = restProps, $[32] = t10, $[33] = t11, $[34] = t12, $[35] = t13, $[36] = t14, $[37] = t15, $[38] = t16, $[39] = t17, $[40] = t18, $[41] = t19, $[42] = t20, $[43] = t21, $[44] = t22, $[45] = t23, $[46] = t24, $[47] = t25, $[48] = t26, $[49] = t27, $[50] = t28, $[51] = t29, $[52] = t4, $[53] = t5, $[54] = t6, $[55] = t7, $[56] = t8, $[57] = t9, $[58] = t30) : t30 = $[58], t30;
});
...
var StyledText = gt.div.withConfig({
...
var Text = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  if (textOverflow === "ellipsis") {
    let t32;
    $[9] !== children ? (t32 = (0, import_jsx_runtime12.jsx)(SpanWithTextOverflow, { children }), $[9] = children, $[10] = t32) : t32 = $[10], children = t32;
  }
  const t3 = useArrayProp(align), t4 = useArrayProp(size22);
  let t5;
  $[11] !== children ? (t5 = (0, import_jsx_runtime12.jsx)("span", { children }), $[11] = children, $[12] = t5) : t5 = $[12];
  let t6;
  return $[13] !== accent || $[14] !== muted || $[15] !== ref || $[16] !== restProps || $[17] !== t3 || $[18] !== t4 || $[19] !== t5 || $[20] !== weight ? (t6 = (0, import_jsx_runtime12.jsx)(StyledText, { "data-ui": "Text", ...restProps, $accent: accent, $align: t3, $muted: muted, ref, $size: t4, $weight: weight, children: t5 }), $[13] = accent, $[14] = muted, $[15] = ref, $[16] = restProps, $[17] = t3, $[18] = t4, $[19] = t5, $[20] = weight, $[21] = t6) : t6 = $[21], t6;
});
...
var StyledBadge = gt(Box).withConfig({
...
var Badge = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t6;
  $[7] !== children || $[8] !== fontSize2 ? (t6 = (0, import_jsx_runtime12.jsx)(Text, { size: fontSize2, children }), $[7] = children, $[8] = fontSize2, $[9] = t6) : t6 = $[9];
  let t7;
  return $[10] !== ref || $[11] !== restProps || $[12] !== t4 || $[13] !== t5 || $[14] !== t6 || $[15] !== tone ? (t7 = (0, import_jsx_runtime12.jsx)(StyledBadge, { "data-ui": "Badge", ...restProps, $tone: tone, $radius: t4, padding: t5, ref, children: t6 }), $[10] = ref, $[11] = restProps, $[12] = t4, $[13] = t5, $[14] = t6, $[15] = tone, $[16] = t7) : t7 = $[16], t7;
});
Badge.displayName = "ForwardRef(Badge)";
var StyledFlex = gt(Box).withConfig({
...
var Flex = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  $[0] !== props ? ({
    ...
    wrap: wrap2,
    ...restProps
  } = props, $[0] = props, $[1] = align, $[2] = as, $[3] = gap, $[4] = justify, $[5] = restProps, $[6] = t0, $[7] = wrap2) : (align = $[1], as = $[2], gap = $[3], justify = $[4], restProps = $[5], t0 = $[6], wrap2 = $[7]);
  ...
  let t6;
  return $[8] !== as || $[9] !== ref || $[10] !== restProps || $[11] !== t1 || $[12] !== t2 || $[13] !== t3 || $[14] !== t4 || $[15] !== t5 ? (t6 = (0, import_jsx_runtime12.jsx)(StyledFlex, { "data-ui": "Flex", ...restProps, $align: t1, $direction: t2, $gap: t3, $justify: t4, $wrap: t5, forwardedAs: as, ref }), $[8] = as, $[9] = ref, $[10] = restProps, $[11] = t1, $[12] = t2, $[13] = t3, $[14] = t4, $[15] = t5, $[16] = t6) : t6 = $[16], t6;
});
...
var Spinner = (0, import_react53.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(4);
  let t0;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime12.jsx)(SpinnerIcon, {}), $[0] = t0) : t0 = $[0];
  let t1;
  return $[1] !== props || $[2] !== ref ? (t1 = (0, import_jsx_runtime12.jsx)(StyledSpinner, { "data-ui": "Spinner", ...props, ref, children: t0 }), $[1] = props, $[2] = ref, $[3] = t1) : t1 = $[3], t1;
});
...
function _cardColorStyle(base, color3, checkered = false) {
  ...
  return {
    ...
    "--card-badge-suggest-bg-color": (_e = color3.badge.suggest) == null ? void 0 : _e.bg,
...
var Button = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t13;
  $[35] !== loading ? (t13 = !!loading && (0, import_jsx_runtime12.jsx)(LoadingBox, { children: (0, import_jsx_runtime12.jsx)(Spinner, {}) }), $[35] = loading, $[36] = t13) : t13 = $[36];
  let t14;
  ...
  let t15;
  $[49] !== boxProps || $[50] !== children ? (t15 = children && (0, import_jsx_runtime12.jsx)(Box, { as: "span", ...boxProps, children }), $[49] = boxProps, $[50] = children, $[51] = t15) : t15 = $[51];
  let t16;
  return $[52] !== mode || $[53] !== radius || $[54] !== ref || $[55] !== restProps || $[56] !== t10 || $[57] !== t11 || $[58] !== t12 || $[59] !== t13 || $[60] !== t14 || $[61] !== t15 || $[62] !== tone || $[63] !== type || $[64] !== width ? (t16 = (0, import_jsx_runtime12.jsxs)(StyledButton, { "data-ui": "Button", ...restProps, $mode: mode, $radius: radius, $tone: tone, "data-disabled": t10, "data-selected": t11, disabled: t12, ref, type, $width: width, children: [
    t13,
    t14,
    t15
...
var StyledCard = gt(Box).withConfig({
...
var Card = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t16;
  $[17] !== as || $[18] !== checkered || $[19] !== focusRing || $[20] !== muted || $[21] !== ref || $[22] !== restProps || $[23] !== rootTheme.scheme || $[24] !== selected || $[25] !== t10 || $[26] !== t11 || $[27] !== t12 || $[28] !== t13 || $[29] !== t14 || $[30] !== t15 || $[31] !== t4 || $[32] !== t6 || $[33] !== t7 || $[34] !== t8 || $[35] !== t9 || $[36] !== tone ? (t16 = (0, import_jsx_runtime12.jsx)(StyledCard, { "data-as": t4, "data-scheme": t5, "data-ui": "Card", "data-tone": tone, ...restProps, $border: t6, $borderTop: t7, $borderRight: t8, $borderBottom: t9, $borderLeft: t10, $checkered: checkered, $focusRing: focusRing, $muted: muted, $radius: t11, $shadow: t12, $tone: tone, "data-checkered": t13, "data-pressed": t14, "data-selected": t15, forwardedAs: as, ref, selected }), $[17] = as, $[18] = checkered, $[19] = focusRing, $[20] = muted, $[21] = ref, $[22] = restProps, $[23] = rootTheme.scheme, $[24] = selected, $[25] = t10, $[26] = t11, $[27] = t12, $[28] = t13, $[29] = t14, $[30] = t15, $[31] = t4, $[32] = t6, $[33] = t7, $[34] = t8, $[35] = t9, $[36] = tone, $[37] = t16) : t16 = $[37];
  let t17;
  return $[38] !== scheme || $[39] !== t16 || $[40] !== tone ? (t17 = (0, import_jsx_runtime12.jsx)(ThemeColorProvider, { scheme, tone, children: t16 }), $[38] = scheme, $[39] = t16, $[40] = tone, $[41] = t17) : t17 = $[41], t17;
});
...
var StyledCheckbox = gt.div.withConfig({
  displayName: "StyledCheckbox",
  componentId: "sc-1l5mt2l-0"
})(checkboxBaseStyles);
var Input$5 = gt.input.withConfig({
  displayName: "Input",
...
var Checkbox = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  let t0;
  $[9] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $[9] = t0) : t0 = $[9], (0, import_react53.useImperativeHandle)(forwardedRef, t0);
  let t1, t2;
  $[10] !== indeterminate ? (t1 = () => {
    ref.current && (ref.current.indeterminate = indeterminate || false);
  }, t2 = [indeterminate], $[10] = indeterminate, $[11] = t1, $[12] = t2) : (t1 = $[11], t2 = $[12]), (0, import_react53.useEffect)(t1, t2), useCustomValidity(ref, customValidity);
  const t3 = !disabled && readOnly ? "" : void 0, t4 = customValidity ? "" : void 0, t5 = disabled || readOnly;
  let t6;
  $[13] !== checked || $[14] !== readOnly || $[15] !== restProps || $[16] !== t3 || $[17] !== t4 || $[18] !== t5 ? (t6 = (0, import_jsx_runtime12.jsx)(Input$5, { "data-read-only": t3, "data-error": t4, ...restProps, checked, disabled: t5, type: "checkbox", readOnly, ref }), $[13] = checked, $[14] = readOnly, $[15] = restProps, $[16] = t3, $[17] = t4, $[18] = t5, $[19] = t6) : t6 = $[19];
  let t7;
  $[20] === Symbol.for("react.memo_cache_sentinel") ? (t7 = (0, import_jsx_runtime12.jsxs)("span", { children: [
    (0, import_jsx_runtime12.jsx)(CheckmarkIcon, {}),
    (0, import_jsx_runtime12.jsx)(RemoveIcon, {})
  ] }), $[20] = t7) : t7 = $[20];
  let t8;
  return $[21] !== className || $[22] !== style || $[23] !== t6 ? (t8 = (0, import_jsx_runtime12.jsxs)(StyledCheckbox, { className, "data-ui": "Checkbox", style, children: [
    t6,
    t7
...
var LazyRefractor = (0, import_react53.lazy)(() => import("./refractor-73C35IYM.js"));
var StyledCode = gt.pre.withConfig({
...
var Code = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t2;
  $[6] !== children ? (t2 = (0, import_jsx_runtime12.jsx)("code", { children }), $[6] = children, $[7] = t2) : t2 = $[7];
  let t3;
  $[8] !== children || $[9] !== language ? (t3 = (0, import_jsx_runtime12.jsx)(LazyRefractor, { language, value: children }), $[8] = children, $[9] = language, $[10] = t3) : t3 = $[10];
  let t4;
  $[11] !== t2 || $[12] !== t3 ? (t4 = (0, import_jsx_runtime12.jsx)(import_react53.Suspense, { fallback: t2, children: t3 }), $[11] = t2, $[12] = t3, $[13] = t4) : t4 = $[13];
  let t5;
  return $[14] !== ref || $[15] !== restProps || $[16] !== t1 || $[17] !== t4 || $[18] !== weight ? (t5 = (0, import_jsx_runtime12.jsx)(StyledCode, { "data-ui": "Code", ...restProps, $size: t1, $weight: weight, ref, children: t4 }), $[14] = ref, $[15] = restProps, $[16] = t1, $[17] = t4, $[18] = weight, $[19] = t5) : t5 = $[19], t5;
});
...
var StyledContainer = gt(Box).withConfig({
...
var Container = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  const t1 = useArrayProp(t0 === void 0 ? 2 : t0);
  let t2;
  return $[4] !== as || $[5] !== ref || $[6] !== restProps || $[7] !== t1 ? (t2 = (0, import_jsx_runtime12.jsx)(StyledContainer, { "data-ui": "Container", ...restProps, $width: t1, forwardedAs: as, ref }), $[4] = as, $[5] = ref, $[6] = restProps, $[7] = t1, $[8] = t2) : t2 = $[8], t2;
});
Container.displayName = "ForwardRef(Container)";
var StyledGrid = gt(Box).withConfig({
...
var Grid = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t9;
  return $[12] !== as || $[13] !== children || $[14] !== ref || $[15] !== restProps || $[16] !== t0 || $[17] !== t1 || $[18] !== t2 || $[19] !== t3 || $[20] !== t4 || $[21] !== t5 || $[22] !== t6 || $[23] !== t7 || $[24] !== t8 ? (t9 = (0, import_jsx_runtime12.jsx)(StyledGrid, { "data-as": t0, "data-ui": "Grid", ...restProps, $autoRows: t1, $autoCols: t2, $autoFlow: t3, $columns: t4, $gap: t5, $gapX: t6, $gapY: t7, $rows: t8, forwardedAs: as, ref, children }), $[12] = as, $[13] = children, $[14] = ref, $[15] = restProps, $[16] = t0, $[17] = t1, $[18] = t2, $[19] = t3, $[20] = t4, $[21] = t5, $[22] = t6, $[23] = t7, $[24] = t8, $[25] = t9) : t9 = $[25], t9;
});
...
var StyledHeading = gt.div.withConfig({
...
var Heading = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  $[11] !== children ? (t5 = (0, import_jsx_runtime12.jsx)("span", { children }), $[11] = children, $[12] = t5) : t5 = $[12];
  let t6;
  return $[13] !== accent || $[14] !== muted || $[15] !== ref || $[16] !== restProps || $[17] !== t3 || $[18] !== t4 || $[19] !== t5 || $[20] !== weight ? (t6 = (0, import_jsx_runtime12.jsx)(StyledHeading, { "data-ui": "Heading", ...restProps, $accent: accent, $align: t3, $muted: muted, $size: t4, $weight: weight, ref, children: t5 }), $[13] = accent, $[14] = muted, $[15] = ref, $[16] = restProps, $[17] = t3, $[18] = t4, $[19] = t5, $[20] = weight, $[21] = t6) : t6 = $[21], t6;
});
...
var StyledInline = gt(Box).withConfig({
...
var Inline = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t0;
  $[5] !== childrenProp ? (t0 = import_react53.Children.map(childrenProp, _temp$4), $[5] = childrenProp, $[6] = t0) : t0 = $[6];
  const children = t0, t1 = useArrayProp(space), t2 = ref;
  let t3;
  return $[7] !== as || $[8] !== children || $[9] !== restProps || $[10] !== t1 || $[11] !== t2 ? (t3 = (0, import_jsx_runtime12.jsx)(StyledInline, { "data-ui": "Inline", ...restProps, $space: t1, forwardedAs: as, ref: t2, children }), $[7] = as, $[8] = children, $[9] = restProps, $[10] = t1, $[11] = t2, $[12] = t3) : t3 = $[12], t3;
});
...
var StyledKBD = gt.kbd.withConfig({
...
var KBD = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t4;
  $[6] !== children || $[7] !== fontSize2 ? (t4 = (0, import_jsx_runtime12.jsx)(Text, { as: "span", size: fontSize2, weight: "semibold", children }), $[6] = children, $[7] = fontSize2, $[8] = t4) : t4 = $[8];
  let t5;
  $[9] !== padding || $[10] !== t4 ? (t5 = (0, import_jsx_runtime12.jsx)(Box, { as: "span", padding, children: t4 }), $[9] = padding, $[10] = t4, $[11] = t5) : t5 = $[11];
  let t6;
  return $[12] !== ref || $[13] !== restProps || $[14] !== t3 || $[15] !== t5 ? (t6 = (0, import_jsx_runtime12.jsx)(StyledKBD, { "data-ui": "KBD", ...restProps, $radius: t3, ref, children: t5 }), $[12] = ref, $[13] = restProps, $[14] = t3, $[15] = t5, $[16] = t6) : t6 = $[16], t6;
});
...
var StyledArrow = gt.div.withConfig({
...
var Arrow = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t3;
  $[10] !== strokeWidth || $[11] !== w ? (t3 = (0, import_jsx_runtime12.jsx)("mask", { id: "stroke-mask", children: (0, import_jsx_runtime12.jsx)("rect", { x: 0, y: strokeWidth, width: w, height: w, fill: "white" }) }), $[10] = strokeWidth, $[11] = w, $[12] = t3) : t3 = $[12];
  const t4 = strokeWidth * 2;
  let t5;
  $[13] !== strokePath || $[14] !== t4 ? (t5 = (0, import_jsx_runtime12.jsx)(StrokePath, { d: strokePath, mask: "url(#stroke-mask)", strokeWidth: t4 }), $[13] = strokePath, $[14] = t4, $[15] = t5) : t5 = $[15];
  let t6;
  $[16] !== fillPath ? (t6 = (0, import_jsx_runtime12.jsx)(ShapePath, { d: fillPath }), $[16] = fillPath, $[17] = t6) : t6 = $[17];
  let t7;
  $[18] !== t2 || $[19] !== t3 || $[20] !== t5 || $[21] !== t6 || $[22] !== w ? (t7 = (0, import_jsx_runtime12.jsxs)("svg", { width: w, height: w, viewBox: t2, children: [
    t3,
    t5,
    t6
  ] }), $[18] = t2, $[19] = t3, $[20] = t5, $[21] = t6, $[22] = w, $[23] = t7) : t7 = $[23];
  let t8;
  return $[24] !== ref || $[25] !== restProps || $[26] !== t7 || $[27] !== w ? (t8 = (0, import_jsx_runtime12.jsx)(StyledArrow, { ...restProps, $w: w, ref, children: t7 }), $[24] = ref, $[25] = restProps, $[26] = t7, $[27] = w, $[28] = t8) : t8 = $[28], t8;
});
...
function BoundaryElementProvider(props) {
  ...
  const value = t0;
  let t1;
  return $[2] !== children || $[3] !== value ? (t1 = (0, import_jsx_runtime12.jsx)(BoundaryElementContext.Provider, { value, children }), $[2] = children, $[3] = value, $[4] = t1) : t1 = $[4], t1;
}
...
var ElementQuery = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  const min = t1;
  let t2, t3;
  $[10] !== element ? (t2 = () => element, t3 = [element], $[10] = element, $[11] = t2, $[12] = t3) : (t2 = $[11], t3 = $[12]), (0, import_react53.useImperativeHandle)(forwardedRef, t2, t3);
  let t4;
  return $[13] !== children || $[14] !== max || $[15] !== min || $[16] !== restProps ? (t4 = (0, import_jsx_runtime12.jsx)("div", { "data-ui": "ElementQuery", ...restProps, "data-eq-max": max, "data-eq-min": min, ref: setElement, children }), $[13] = children, $[14] = max, $[15] = min, $[16] = restProps, $[17] = t4) : t4 = $[17], t4;
});
...
function LayerProvider(props) {
  ...
  const [, setChildLayers] = (0, import_react53.useState)(t2), [size22, setSize] = (0, import_react53.useState)(0), isTopLayer = size22 === 0;
  let t3;
  ...
  let t4, t5;
  $[6] !== level || $[7] !== parentRegisterChild ? (t4 = () => parentRegisterChild == null ? void 0 : parentRegisterChild(level), t5 = [level, parentRegisterChild], $[6] = level, $[7] = parentRegisterChild, $[8] = t4, $[9] = t5) : (t4 = $[8], t5 = $[9]), (0, import_react53.useEffect)(t4, t5);
  let t6;
  $[10] !== isTopLayer || $[11] !== level || $[12] !== registerChild || $[13] !== size22 || $[14] !== zIndex ? (t6 = {
    version: 0,
    isTopLayer,
    level,
    registerChild,
    size: size22,
    zIndex
  }, $[10] = isTopLayer, $[11] = level, $[12] = registerChild, $[13] = size22, $[14] = zIndex, $[15] = t6) : t6 = $[15];
  const value = t6;
  let t7;
  return $[16] !== children || $[17] !== value ? (t7 = (0, import_jsx_runtime12.jsx)(LayerContext.Provider, { value, children }), $[16] = children, $[17] = value, $[18] = t7) : t7 = $[18], t7;
}
...
function useLayer() {
  const $ = (0, import_react_compiler_runtime.c)(2), value = (0, import_react53.useContext)(LayerContext);
  if (!value)
...
var StyledLayer = gt.div.withConfig({
...
var LayerChildren = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  const style = t0 === void 0 ? EMPTY_RECORD : t0, {
    zIndex,
    isTopLayer
  } = useLayer(), lastFocusedRef = (0, import_react53.useRef)(null), ref = (0, import_react53.useRef)(null), isTopLayerRef = (0, import_react53.useRef)(isTopLayer);
  let t1;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => ref.current, $[6] = t1) : t1 = $[6], (0, import_react53.useImperativeHandle)(forwardedRef, t1);
  let t2, t3;
  ...
  }, t3 = [isTopLayer, onActivate], $[7] = isTopLayer, $[8] = onActivate, $[9] = t2, $[10] = t3) : (t2 = $[9], t3 = $[10]), (0, import_react53.useEffect)(t2, t3);
  let t4;
  $[11] !== isTopLayer || $[12] !== onFocus ? (t4 = (event) => {
    onFocus == null ? void 0 : onFocus(event);
    const rootElement = ref.current, target = document.activeElement;
    !isTopLayer || !rootElement || !target || isHTMLElement2(target) && containsOrEqualsElement(rootElement, target) && (lastFocusedRef.current = target);
  ...
  let t6;
  return $[17] !== children || $[18] !== handleFocus || $[19] !== restProps || $[20] !== t5 ? (t6 = (0, import_jsx_runtime12.jsx)(StyledLayer, { ...restProps, "data-ui": "Layer", onFocus: handleFocus, ref, style: t5, children }), $[17] = children, $[18] = handleFocus, $[19] = restProps, $[20] = t5, $[21] = t6) : t6 = $[21], t6;
});
var Layer = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t1;
  $[4] !== children || $[5] !== ref || $[6] !== restProps ? (t1 = (0, import_jsx_runtime12.jsx)(LayerChildren, { ...restProps, ref, children }), $[4] = children, $[5] = ref, $[6] = restProps, $[7] = t1) : t1 = $[7];
  let t2;
  return $[8] !== t1 || $[9] !== zOffset ? (t2 = (0, import_jsx_runtime12.jsx)(LayerProvider, { zOffset, children: t1 }), $[8] = t1, $[9] = zOffset, $[10] = t2) : t2 = $[10], t2;
});
...
function PortalProvider(props) {
  ...
  const value = t2;
  let t3;
  return $[4] !== children || $[5] !== value ? (t3 = (0, import_jsx_runtime12.jsx)(PortalContext.Provider, { value, children }), $[4] = children, $[5] = value, $[6] = t3) : t3 = $[6], t3;
}
function _temp2$1() {
  return null;
}
...
var SrOnly = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t0;
  return $[0] !== as || $[1] !== children || $[2] !== ref ? (t0 = (0, import_jsx_runtime12.jsx)(StyledSrOnly, { "aria-hidden": true, as, "data-ui": "SrOnly", ref, children }), $[0] = as, $[1] = children, $[2] = ref, $[3] = t0) : t0 = $[3], t0;
});
...
var VirtualList = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  let t4;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref.current, $[10] = t4) : t4 = $[10], (0, import_react53.useImperativeHandle)(forwardedRef, t4);
  let t5;
  ...
  let t6;
  $[12] !== renderItem ? (t6 = [renderItem], $[12] = renderItem, $[13] = t6) : t6 = $[13], (0, import_react53.useEffect)(t5, t6);
  let t7, t8;
  ...
  }, t8 = [], $[14] = t7, $[15] = t8) : (t7 = $[14], t8 = $[15]), (0, import_react53.useEffect)(t7, t8);
  ...
  }, t10 = [fromIndex, gap, itemHeight, onChange, scrollHeight, scrollTop, space, toIndex], $[16] = fromIndex, $[17] = gap, $[18] = itemHeight, $[19] = onChange, $[20] = scrollHeight, $[21] = scrollTop, $[22] = space, $[23] = toIndex, $[24] = t10, $[25] = t9) : (t10 = $[24], t9 = $[25]), (0, import_react53.useEffect)(t9, t10);
  let t11;
  bb0: {
    ...
    if (itemHeight === -1) {
      ...
      let t132;
      $[29] !== t123 ? (t132 = [(0, import_jsx_runtime12.jsx)(ItemWrapper, { children: t123 }, 0)], $[29] = t123, $[30] = t132) : t132 = $[30], t11 = t132;
      break bb0;
    }
    let t122;
  ...
  let t13;
  $[49] !== children || $[50] !== wrapperStyle ? (t13 = (0, import_jsx_runtime12.jsx)("div", { ref: wrapperRef, style: wrapperStyle, children }), $[49] = children, $[50] = wrapperStyle, $[51] = t13) : t13 = $[51];
  let t14;
  return $[52] !== as || $[53] !== restProps || $[54] !== t13 ? (t14 = (0, import_jsx_runtime12.jsx)(StyledVirtualList, { as, "data-ui": "VirtualList", ...restProps, ref, children: t13 }), $[52] = as, $[53] = restProps, $[54] = t13, $[55] = t14) : t14 = $[55], t14;
});
...
var MotionFlex = gt(motion.create(Flex)).withConfig({
...
var PopoverCard = (0, import_react53.memo)((0, import_react53.forwardRef)(function(props, ref) {
  ...
  $[0] !== props ? ({
    ...
    y: yProp,
    ...restProps
  } = props, $[0] = props, $[1] = animate2, $[2] = arrow22, $[3] = arrowRef, $[4] = arrowX, $[5] = arrowY, $[6] = children, $[7] = marginsProp, $[8] = originX, $[9] = originY, $[10] = overflow, $[11] = padding, $[12] = placement, $[13] = radius, $[14] = restProps, $[15] = scheme, $[16] = shadow, $[17] = strategy, $[18] = style, $[19] = tone, $[20] = width, $[21] = xProp, $[22] = yProp) : (animate2 = $[1], arrow22 = $[2], arrowRef = $[3], arrowX = $[4], arrowY = $[5], children = $[6], marginsProp = $[7], originX = $[8], originY = $[9], overflow = $[10], padding = $[11], placement = $[12], radius = $[13], restProps = $[14], scheme = $[15], shadow = $[16], strategy = $[17], style = $[18], tone = $[19], width = $[20], xProp = $[21], yProp = $[22]);
  const {
    zIndex
  } = useLayer(), margins = marginsProp || DEFAULT_POPOVER_MARGINS, x = (xProp ?? 0) + margins[3], y = (yProp ?? 0) + margins[0], t0 = animate2 ? "transform" : void 0;
  let t1;
  ...
  let t6;
  $[36] !== animate2 ? (t6 = animate2 ? ["hidden", "initial"] : void 0, $[36] = animate2, $[37] = t6) : t6 = $[37];
  let t7;
  $[38] !== animate2 ? (t7 = animate2 ? ["visible", "scaleIn"] : void 0, $[38] = animate2, $[39] = t7) : t7 = $[39];
  let t8;
  $[40] !== animate2 ? (t8 = animate2 ? ["hidden", "scaleOut"] : void 0, $[40] = animate2, $[41] = t8) : t8 = $[41];
  let t9;
  $[42] !== children || $[43] !== padding ? (t9 = (0, import_jsx_runtime12.jsx)(Flex, { direction: "column", flex: 1, padding, children }), $[42] = children, $[43] = padding, $[44] = t9) : t9 = $[44];
  let t10;
  $[45] !== overflow || $[46] !== t9 ? (t10 = (0, import_jsx_runtime12.jsx)(MotionFlex, { "data-ui": "Popover__wrapper", direction: "column", flex: 1, overflow, variants: POPOVER_MOTION_PROPS.children, transition: POPOVER_MOTION_PROPS.transition, children: t9 }), $[45] = overflow, $[46] = t9, $[47] = t10) : t10 = $[47];
  let t11;
  $[48] !== arrow22 || $[49] !== arrowRef || $[50] !== arrowStyle ? (t11 = arrow22 && (0, import_jsx_runtime12.jsx)(Arrow, { ref: arrowRef, style: arrowStyle, width: DEFAULT_POPOVER_ARROW_WIDTH, height: DEFAULT_POPOVER_ARROW_HEIGHT, radius: DEFAULT_POPOVER_ARROW_RADIUS }), $[48] = arrow22, $[49] = arrowRef, $[50] = arrowStyle, $[51] = t11) : t11 = $[51];
  let t12;
  return $[52] !== placement || $[53] !== radius || $[54] !== ref || $[55] !== rootStyle2 || $[56] !== scheme || $[57] !== shadow || $[58] !== t10 || $[59] !== t11 || $[60] !== t5 || $[61] !== t6 || $[62] !== t7 || $[63] !== t8 || $[64] !== tone ? (t12 = (0, import_jsx_runtime12.jsxs)(MotionCard$1, { "data-ui": "Popover", ...t5, "data-placement": placement, radius, ref, scheme, shadow, sizing: "border", style: rootStyle2, tone, variants: POPOVER_MOTION_PROPS.card, transition: POPOVER_MOTION_PROPS.transition, initial: t6, animate: t7, exit: t8, children: [
    t10,
    t11
...
var ViewportOverlay = () => {
  ...
  let t0;
  return $[0] !== zIndex ? (t0 = (0, import_jsx_runtime12.jsx)("div", { style: {
    height: "100vh",
    inset: 0,
    position: "fixed",
    width: "100vw",
...
var Popover = (0, import_react53.memo)((0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  const middleware = (0, import_react53.useMemo)(() => {
    const ret = [];
    return (constrainSize || preventOverflow) && (placementStrategy === "autoPlacement" ? ret.push(autoPlacement2({
    ...
    })), (constrainSize || matchReferenceWidth) && ret.push(size2({
      apply({
        availableWidth,
        availableHeight,
        elements,
      ...
      margins,
      padding: DEFAULT_POPOVER_PADDING
    })), preventOverflow && ret.push(shift2({
      boundary: floatingBoundary || void 0,
      rootBoundary,
      padding: DEFAULT_POPOVER_PADDING
    })), arrowProp && ret.push(arrow2({
      element: arrowRef,
      padding: DEFAULT_POPOVER_PADDING
    })), animate2 && ret.push(origin), ret.push(hide2({
  ...
  }, []), setFloating = (0, import_react53.useCallback)((node) => {
...
var StyledRadio = gt.div.withConfig({
  displayName: "StyledRadio",
  componentId: "sc-ccrwkf-0"
})(radioBaseStyle);
var Input$4 = gt.input.withConfig({
  displayName: "Input",
...
var Radio = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  const ref = (0, import_react53.useRef)(null);
  let t0;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $[7] = t0) : t0 = $[7], (0, import_react53.useImperativeHandle)(forwardedRef, t0), useCustomValidity(ref, customValidity);
  const t1 = !disabled && readOnly ? "" : void 0, t2 = customValidity ? "" : void 0, t3 = disabled || readOnly;
  let t4;
  $[8] !== readOnly || $[9] !== restProps || $[10] !== t1 || $[11] !== t2 || $[12] !== t3 ? (t4 = (0, import_jsx_runtime12.jsx)(Input$4, { "data-read-only": t1, "data-error": t2, ...restProps, disabled: t3, readOnly, ref, type: "radio" }), $[8] = readOnly, $[9] = restProps, $[10] = t1, $[11] = t2, $[12] = t3, $[13] = t4) : t4 = $[13];
  let t5;
  $[14] === Symbol.for("react.memo_cache_sentinel") ? (t5 = (0, import_jsx_runtime12.jsx)("span", {}), $[14] = t5) : t5 = $[14];
  let t6;
  return $[15] !== className || $[16] !== style || $[17] !== t4 ? (t6 = (0, import_jsx_runtime12.jsxs)(StyledRadio, { className, "data-ui": "Radio", style, children: [
    t4,
    t5
...
var StyledSelect = gt.div.withConfig({
  displayName: "StyledSelect",
  componentId: "sc-5mxno7-0"
})(selectStyle.root);
var Input$3 = gt.select.withConfig({
  displayName: "Input",
  componentId: "sc-5mxno7-1"
})(selectStyle.input);
var IconBox = gt(Box).withConfig({
  displayName: "IconBox",
...
var Select = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  let t4;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref.current, $[10] = t4) : t4 = $[10], (0, import_react53.useImperativeHandle)(forwardedRef, t4), useCustomValidity(ref, customValidity);
  ...
  let t11;
  $[11] !== children || $[12] !== restProps || $[13] !== t10 || $[14] !== t5 || $[15] !== t6 || $[16] !== t7 || $[17] !== t8 || $[18] !== t9 ? (t11 = (0, import_jsx_runtime12.jsx)(Input$3, { "data-read-only": t5, "data-ui": "Select", ...restProps, $fontSize: t6, $padding: t7, $radius: t8, $space: t9, disabled: t10, ref, children }), $[11] = children, $[12] = restProps, $[13] = t10, $[14] = t5, $[15] = t6, $[16] = t7, $[17] = t8, $[18] = t9, $[19] = t11) : t11 = $[19];
  let t12;
  $[20] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime12.jsx)(ChevronDownIcon, {}), $[20] = t12) : t12 = $[20];
  let t13;
  $[21] !== fontSize2 ? (t13 = (0, import_jsx_runtime12.jsx)(Text, { size: fontSize2, children: t12 }), $[21] = fontSize2, $[22] = t13) : t13 = $[22];
  let t14;
  $[23] !== padding || $[24] !== t13 ? (t14 = (0, import_jsx_runtime12.jsx)(IconBox, { padding, children: t13 }), $[23] = padding, $[24] = t13, $[25] = t14) : t14 = $[25];
  let t15;
  return $[26] !== t11 || $[27] !== t14 ? (t15 = (0, import_jsx_runtime12.jsxs)(StyledSelect, { "data-ui": "Select", children: [
    t11,
    t14
...
var StyledStack = gt(Box).withConfig({
...
var Stack = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  let t2;
  return $[4] !== as || $[5] !== ref || $[6] !== restProps || $[7] !== t0 || $[8] !== t1 ? (t2 = (0, import_jsx_runtime12.jsx)(StyledStack, { "data-as": t0, "data-ui": "Stack", ...restProps, $space: t1, forwardedAs: as, ref }), $[4] = as, $[5] = ref, $[6] = restProps, $[7] = t0, $[8] = t1, $[9] = t2) : t2 = $[9], t2;
});
...
var StyledSwitch = gt.span.withConfig({
  displayName: "StyledSwitch",
  componentId: "sc-dw1foe-0"
})(switchBaseStyles);
var Input$2 = gt.input.withConfig({
  displayName: "Input",
  componentId: "sc-dw1foe-1"
})(switchInputStyles);
var Representation = gt.span.withConfig({
  displayName: "Representation",
  componentId: "sc-dw1foe-2"
})(switchRepresentationStyles);
var Track = gt.span.withConfig({
  displayName: "Track",
  componentId: "sc-dw1foe-3"
})(switchTrackStyles);
var Thumb = gt.span.withConfig({
  displayName: "Thumb",
...
var Switch = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  const ref = (0, import_react53.useRef)(null);
  let t0;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $[8] = t0) : t0 = $[8], (0, import_react53.useImperativeHandle)(forwardedRef, t0);
  let t1, t2;
  $[9] !== indeterminate ? (t1 = () => {
    ref.current && (ref.current.indeterminate = indeterminate || false);
  }, t2 = [indeterminate], $[9] = indeterminate, $[10] = t1, $[11] = t2) : (t1 = $[10], t2 = $[11]), (0, import_react53.useEffect)(t1, t2);
  const t3 = !disabled && readOnly ? "" : void 0, t4 = indeterminate !== true && checked, t5 = disabled || readOnly;
  let t6;
  $[12] !== restProps || $[13] !== t3 || $[14] !== t4 || $[15] !== t5 ? (t6 = (0, import_jsx_runtime12.jsx)(Input$2, { "data-read-only": t3, ...restProps, checked: t4, disabled: t5, type: "checkbox", ref }), $[12] = restProps, $[13] = t3, $[14] = t4, $[15] = t5, $[16] = t6) : t6 = $[16];
  let t7;
  $[17] === Symbol.for("react.memo_cache_sentinel") ? (t7 = (0, import_jsx_runtime12.jsx)(Track, {}), $[17] = t7) : t7 = $[17];
  let t8;
  $[18] !== checked || $[19] !== indeterminate ? (t8 = (0, import_jsx_runtime12.jsxs)(Representation, { "aria-hidden": true, "data-name": "representation", children: [
    t7,
    (0, import_jsx_runtime12.jsx)(Thumb, { $checked: checked, $indeterminate: indeterminate })
  ] }), $[18] = checked, $[19] = indeterminate, $[20] = t8) : t8 = $[20];
  let t9;
  return $[21] !== className || $[22] !== style || $[23] !== t6 || $[24] !== t8 ? (t9 = (0, import_jsx_runtime12.jsxs)(StyledSwitch, { className, "data-ui": "Switch", style, children: [
    t6,
    t8
  ] }), $[21] = className, $[22] = style, $[23] = t6, $[24] = t8, $[25] = t9) : t9 = $[25], t9;
});
Switch.displayName = "ForwardRef(Switch)";
var StyledTextArea = gt.span.withConfig({
...
var TextArea = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  let t5;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t5 = () => ref.current, $[10] = t5) : t5 = $[10], (0, import_react53.useImperativeHandle)(forwardedRef, t5), useCustomValidity(ref, customValidity);
  ...
  let t12;
  $[11] !== disabled || $[12] !== restProps || $[13] !== rootTheme.scheme || $[14] !== rootTheme.tone || $[15] !== t11 || $[16] !== t8 || $[17] !== t9 || $[18] !== weight ? (t12 = (0, import_jsx_runtime12.jsx)(Input$1, { "data-as": "textarea", "data-scheme": t6, "data-tone": t7, ...restProps, $fontSize: t8, $padding: t9, $scheme: t10, $space: t11, $tone: rootTheme.tone, $weight: weight, disabled, ref }), $[11] = disabled, $[12] = restProps, $[13] = rootTheme.scheme, $[14] = rootTheme.tone, $[15] = t11, $[16] = t8, $[17] = t9, $[18] = weight, $[19] = t12) : t12 = $[19];
  const t13 = useArrayProp(radius), t14 = border2 ? "" : void 0;
  let t15;
  $[20] !== __unstable_disableFocusRing || $[21] !== rootTheme.scheme || $[22] !== rootTheme.tone || $[23] !== t13 || $[24] !== t14 ? (t15 = (0, import_jsx_runtime12.jsx)(Presentation$1, { $radius: t13, $unstableDisableFocusRing: __unstable_disableFocusRing, $scheme: rootTheme.scheme, $tone: rootTheme.tone, "data-border": t14, "data-scheme": rootTheme.scheme, "data-tone": rootTheme.tone }), $[20] = __unstable_disableFocusRing, $[21] = rootTheme.scheme, $[22] = rootTheme.tone, $[23] = t13, $[24] = t14, $[25] = t15) : t15 = $[25];
  let t16;
  return $[26] !== t12 || $[27] !== t15 ? (t16 = (0, import_jsx_runtime12.jsx)(StyledTextArea, { "data-ui": "TextArea", children: (0, import_jsx_runtime12.jsxs)(InputRoot$1, { children: [
    t12,
    t15
...
var StyledTextInput = gt(Card).attrs({
  forwardedAs: "span"
}).withConfig({
...
var TextInputClearButton = gt(Button).withConfig({
...
var TextInput = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  let t7;
  $[19] === Symbol.for("react.memo_cache_sentinel") ? (t7 = () => ref.current, $[19] = t7) : t7 = $[19], (0, import_react53.useImperativeHandle)(forwardedRef, t7), useCustomValidity(ref, customValidity);
  ...
  let t9;
  $[22] !== prefix || $[23] !== radius ? (t9 = prefix && (0, import_jsx_runtime12.jsx)(Prefix, { borderTop: true, borderLeft: true, borderBottom: true, radius, sizing: "border", tone: "inherit", children: (0, import_jsx_runtime12.jsx)("span", { children: prefix }) }), $[22] = prefix, $[23] = radius, $[24] = t9) : t9 = $[24];
  const prefixNode = t9, t10 = border2 ? "" : void 0;
  let t11;
  $[25] !== IconComponent || $[26] !== fontSize2 || $[27] !== padding ? (t11 = IconComponent && (0, import_jsx_runtime12.jsx)(LeftBox, { padding, children: (0, import_jsx_runtime12.jsxs)(Text, { size: fontSize2, children: [
    (0, import_react53.isValidElement)(IconComponent) && IconComponent,
    (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime12.jsx)(IconComponent, {})
  ] }) }), $[25] = IconComponent, $[26] = fontSize2, $[27] = padding, $[28] = t11) : t11 = $[28];
  let t12;
  $[29] !== $hasClearButton || $[30] !== IconRightComponent || $[31] !== fontSize2 || $[32] !== padding ? (t12 = !$hasClearButton && IconRightComponent && (0, import_jsx_runtime12.jsx)(RightBox, { padding, children: (0, import_jsx_runtime12.jsxs)(Text, { size: fontSize2, children: [
    (0, import_react53.isValidElement)(IconRightComponent) && IconRightComponent,
    (0, import_react_is.isValidElementType)(IconRightComponent) && (0, import_jsx_runtime12.jsx)(IconRightComponent, {})
  ] }) }), $[29] = $hasClearButton, $[30] = IconRightComponent, $[31] = fontSize2, $[32] = padding, $[33] = t12) : t12 = $[33];
  let t13;
  $[34] !== $hasPrefix || $[35] !== $hasSuffix || $[36] !== __unstable_disableFocusRing || $[37] !== radius || $[38] !== rootTheme.scheme || $[39] !== rootTheme.tone || $[40] !== t10 || $[41] !== t11 || $[42] !== t12 ? (t13 = (0, import_jsx_runtime12.jsxs)(Presentation, { $hasPrefix, $unstableDisableFocusRing: __unstable_disableFocusRing, $hasSuffix, $radius: radius, $scheme: rootTheme.scheme, $tone: rootTheme.tone, "data-border": t10, "data-scheme": rootTheme.scheme, "data-tone": rootTheme.tone, children: [
    t11,
    t12
  ...
  let t16;
  $[48] !== clearButton || $[49] !== clearButtonBoxPadding || $[50] !== clearButtonPadding || $[51] !== clearButtonProps || $[52] !== customValidity || $[53] !== disabled || $[54] !== fontSize2 || $[55] !== handleClearClick || $[56] !== radius || $[57] !== readOnly ? (t16 = !disabled && !readOnly && clearButton && (0, import_jsx_runtime12.jsx)(RightCard, { forwardedAs: "span", padding: clearButtonBoxPadding, style: CLEAR_BUTTON_BOX_STYLE, tone: customValidity ? "critical" : "inherit", children: (0, import_jsx_runtime12.jsx)(TextInputClearButton, { "aria-label": "Clear", "data-qa": "clear-button", fontSize: fontSize2, icon: CloseIcon, mode: "bleed", padding: clearButtonPadding, radius, ...clearButtonProps, onClick: handleClearClick, onMouseDown: handleClearMouseDown }) }), $[48] = clearButton, $[49] = clearButtonBoxPadding, $[50] = clearButtonPadding, $[51] = clearButtonProps, $[52] = customValidity, $[53] = disabled, $[54] = fontSize2, $[55] = handleClearClick, $[56] = radius, $[57] = readOnly, $[58] = t16) : t16 = $[58];
  const clearButtonNode = t16;
  let t17;
  $[59] !== radius || $[60] !== suffix ? (t17 = suffix && (0, import_jsx_runtime12.jsx)(Suffix, { borderTop: true, borderRight: true, borderBottom: true, radius, sizing: "border", tone: "inherit", children: (0, import_jsx_runtime12.jsx)("span", { children: suffix }) }), $[59] = radius, $[60] = suffix, $[61] = t17) : t17 = $[61];
  const suffixNode = t17, t18 = $hasIconRight || $hasClearButton;
  let t19;
  $[62] !== $hasIcon || $[63] !== disabled || $[64] !== fontSize2 || $[65] !== padding || $[66] !== readOnly || $[67] !== restProps || $[68] !== rootTheme.scheme || $[69] !== rootTheme.tone || $[70] !== space || $[71] !== t18 || $[72] !== type || $[73] !== weight ? (t19 = (0, import_jsx_runtime12.jsx)(Input, { "data-as": "input", "data-scheme": rootTheme.scheme, "data-tone": rootTheme.tone, ...restProps, $fontSize: fontSize2, $iconLeft: $hasIcon, $iconRight: t18, $padding: padding, $scheme: rootTheme.scheme, $space: space, $tone: rootTheme.tone, $weight: weight, disabled, readOnly, ref, type }), $[62] = $hasIcon, $[63] = disabled, $[64] = fontSize2, $[65] = padding, $[66] = readOnly, $[67] = restProps, $[68] = rootTheme.scheme, $[69] = rootTheme.tone, $[70] = space, $[71] = t18, $[72] = type, $[73] = weight, $[74] = t19) : t19 = $[74];
  let t20;
  $[75] !== clearButtonNode || $[76] !== presentationNode || $[77] !== t19 ? (t20 = (0, import_jsx_runtime12.jsxs)(InputRoot, { children: [
    t19,
    presentationNode,
    clearButtonNode
  ] }), $[75] = clearButtonNode, $[76] = presentationNode, $[77] = t19, $[78] = t20) : t20 = $[78];
  let t21;
  return $[79] !== prefixNode || $[80] !== rootTheme.tone || $[81] !== suffixNode || $[82] !== t20 ? (t21 = (0, import_jsx_runtime12.jsxs)(StyledTextInput, { "data-ui": "TextInput", tone: rootTheme.tone, children: [
    prefixNode,
    t20,
    suffixNode
...
function useDelayedState(initialState) {
  const $ = (0, import_react_compiler_runtime.c)(3), [state, setState] = (0, import_react53.useState)(initialState), delayedAction = (0, import_react53.useRef)(void 0);
  let t0;
...
var TooltipCard = (0, import_react53.memo)((0, import_react53.forwardRef)(function(props, ref) {
  ...
  $[0] !== props ? ({
    ...
    style,
    ...restProps
  } = props, $[0] = props, $[1] = animate2, $[2] = arrow22, $[3] = arrowRef, $[4] = arrowX, $[5] = arrowY, $[6] = children, $[7] = originX, $[8] = originY, $[9] = padding, $[10] = placement, $[11] = radius, $[12] = restProps, $[13] = scheme, $[14] = shadow, $[15] = style) : (animate2 = $[1], arrow22 = $[2], arrowRef = $[3], arrowX = $[4], arrowY = $[5], children = $[6], originX = $[7], originY = $[8], padding = $[9], placement = $[10], radius = $[11], restProps = $[12], scheme = $[13], shadow = $[14], style = $[15]);
  ...
  const arrowStyle = t4, t5 = restProps;
  let t6;
  $[24] !== animate2 ? (t6 = animate2 ? ["hidden", "initial"] : void 0, $[24] = animate2, $[25] = t6) : t6 = $[25];
  let t7;
  $[26] !== animate2 ? (t7 = animate2 ? ["visible", "scaleIn"] : void 0, $[26] = animate2, $[27] = t7) : t7 = $[27];
  let t8;
  $[28] !== animate2 ? (t8 = animate2 ? ["hidden", "scaleOut"] : void 0, $[28] = animate2, $[29] = t8) : t8 = $[29];
  let t9;
  $[30] !== arrow22 || $[31] !== arrowRef || $[32] !== arrowStyle ? (t9 = arrow22 && (0, import_jsx_runtime12.jsx)(Arrow, { ref: arrowRef, style: arrowStyle, width: DEFAULT_TOOLTIP_ARROW_WIDTH, height: DEFAULT_TOOLTIP_ARROW_HEIGHT, radius: DEFAULT_TOOLTIP_ARROW_RADIUS }), $[30] = arrow22, $[31] = arrowRef, $[32] = arrowStyle, $[33] = t9) : t9 = $[33];
  let t10;
  return $[34] !== children || $[35] !== padding || $[36] !== placement || $[37] !== radius || $[38] !== ref || $[39] !== rootStyle2 || $[40] !== scheme || $[41] !== shadow || $[42] !== t5 || $[43] !== t6 || $[44] !== t7 || $[45] !== t8 || $[46] !== t9 ? (t10 = (0, import_jsx_runtime12.jsxs)(MotionCard, { "data-ui": "Tooltip__card", ...t5, "data-placement": placement, padding, radius, ref, scheme, shadow, style: rootStyle2, variants: POPOVER_MOTION_PROPS.card, transition: POPOVER_MOTION_PROPS.transition, initial: t6, animate: t7, exit: t8, children: [
    children,
    t9
...
function TooltipDelayGroupProvider(props) {
  ...
  const value = t1;
  let t2;
  return $[6] !== children || $[7] !== value ? (t2 = (0, import_jsx_runtime12.jsx)(TooltipDelayGroupContext.Provider, { value, children }), $[6] = children, $[7] = value, $[8] = t2) : t2 = $[8], t2;
}
...
var Tooltip = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  (0, import_react53.useImperativeHandle)(forwardedRef, () => ref.current);
  const portal = usePortal(), portalElement = typeof portalProp == "string" ? ((_a = portal.elements) == null ? void 0 : _a[portalProp]) || null : portal.element, middleware = (0, import_react53.useMemo)(() => {
    const ret = [];
    return ret.push(flip2({
  ...
  }), arrowX = (_b = middlewareData.arrow) == null ? void 0 : _b.x, arrowY = (_c = middlewareData.arrow) == null ? void 0 : _c.y, originX = (_d = middlewareData["@sanity/ui/origin"]) == null ? void 0 : _d.originX, originY = (_e = middlewareData["@sanity/ui/origin"]) == null ? void 0 : _e.originY, tooltipId = (0, import_react53.useId)(), [isOpen, setIsOpen] = useDelayedState(false), delayGroupContext = useTooltipDelayGroup(), {
    setIsGroupActive,
    setOpenTooltipId
  ...
  }, [update]), setFloating = (0, import_react53.useCallback)((node) => {
    ref.current = node, refs.setFloating(node);
...
function useCloseOnMouseLeave(t0) {
  ...
  let t3;
  $[7] !== isInsideGroup || $[8] !== showTooltip ? (t3 = [isInsideGroup, showTooltip], $[7] = isInsideGroup, $[8] = showTooltip, $[9] = t3) : t3 = $[9], (0, import_react53.useEffect)(t2, t3);
}
...
var Hotkeys = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  if (!keys || keys.length === 0) {
    let t12;
    return $[7] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, {}), $[7] = t12) : t12 = $[7], t12;
  }
  let t1;
  if ($[8] !== fontSize2 || $[9] !== keys || $[10] !== padding || $[11] !== radius) {
    let t22;
    $[13] !== fontSize2 || $[14] !== padding || $[15] !== radius ? (t22 = (key2, i) => (0, import_jsx_runtime12.jsx)(Key, { fontSize: fontSize2, padding, radius, children: key2 }, i), $[13] = fontSize2, $[14] = padding, $[15] = radius, $[16] = t22) : t22 = $[16], t1 = keys.map(t22), $[8] = fontSize2, $[9] = keys, $[10] = padding, $[11] = radius, $[12] = t1;
  } else
    t1 = $[12];
  let t2;
  $[17] !== space || $[18] !== t1 ? (t2 = (0, import_jsx_runtime12.jsx)(Inline, { as: "span", space, children: t1 }), $[17] = space, $[18] = t1, $[19] = t2) : t2 = $[19];
  let t3;
  return $[20] !== ref || $[21] !== restProps || $[22] !== t2 ? (t3 = (0, import_jsx_runtime12.jsx)(StyledHotkeys, { "data-ui": "Hotkeys", ...restProps, ref, children: t2 }), $[20] = ref, $[21] = restProps, $[22] = t2, $[23] = t3) : t3 = $[23], t3;
});
...
var Menu = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  let t2;
  $[13] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => ref.current, $[13] = t2) : t2 = $[13], (0, import_react53.useImperativeHandle)(forwardedRef, t2);
  const {
    isTopLayer
  } = useLayer();
  let t3;
  ...
  }, t6 = [activeIndex, onItemSelect], $[20] = activeIndex, $[21] = onItemSelect, $[22] = t5, $[23] = t6) : (t5 = $[22], t6 = $[23]), (0, import_react53.useEffect)(t5, t6);
  let t7;
  ...
  const value = t9;
  let t10;
  $[38] !== children || $[39] !== space ? (t10 = (0, import_jsx_runtime12.jsx)(Stack, { space, children }), $[38] = children, $[39] = space, $[40] = t10) : t10 = $[40];
  let t11;
  $[41] !== handleKeyDown || $[42] !== handleRefChange || $[43] !== padding || $[44] !== restProps || $[45] !== t10 ? (t11 = (0, import_jsx_runtime12.jsx)(StyledMenu, { "data-ui": "Menu", ...restProps, onKeyDown: handleKeyDown, padding, ref: handleRefChange, role: "menu", tabIndex: -1, children: t10 }), $[41] = handleKeyDown, $[42] = handleRefChange, $[43] = padding, $[44] = restProps, $[45] = t10, $[46] = t11) : t11 = $[46];
  let t12;
  return $[47] !== t11 || $[48] !== value ? (t12 = (0, import_jsx_runtime12.jsx)(MenuContext.Provider, { value, children: t11 }), $[47] = t11, $[48] = value, $[49] = t12) : t12 = $[49], t12;
});
...
var Selectable = gt(Box).withConfig({
...
function MenuGroup(props) {
  ...
  let t11, t12;
  $[23] !== mount || $[24] !== rootElement ? (t11 = () => mount(rootElement), t12 = [mount, rootElement], $[23] = mount, $[24] = rootElement, $[25] = t11, $[26] = t12) : (t11 = $[25], t12 = $[26]), (0, import_react53.useEffect)(t11, t12);
  let t13, t14;
  $[27] !== active ? (t13 = () => {
    active || setOpen(false);
  }, t14 = [active], $[27] = active, $[28] = t13, $[29] = t14) : (t13 = $[28], t14 = $[29]), (0, import_react53.useEffect)(t13, t14);
  let t15, t16;
  $[30] !== open ? (t15 = () => {
    open || setWithinMenu(false);
  }, t16 = [open], $[30] = open, $[31] = t15, $[32] = t16) : (t15 = $[31], t16 = $[32]), (0, import_react53.useEffect)(t15, t16);
  let t17, t18;
  $[33] !== shouldFocus ? (t17 = () => {
    if (!shouldFocus)
      return;
    ...
    return () => cancelAnimationFrame(rafId);
  }, t18 = [shouldFocus], $[33] = shouldFocus, $[34] = t17, $[35] = t18) : (t17 = $[34], t18 = $[35]), (0, import_react53.useEffect)(t17, t18);
  let t19;
  $[36] !== children || $[37] !== handleChildItemClick || $[38] !== handleMenuKeyDown || $[39] !== menuProps || $[40] !== onClickOutside || $[41] !== onEscape || $[42] !== registerElement || $[43] !== shouldFocus ? (t19 = (0, import_jsx_runtime12.jsx)(Menu, { ...menuProps, onClickOutside, onEscape, onItemClick: handleChildItemClick, onKeyDown: handleMenuKeyDown, onMouseEnter: handleMenuMouseEnter, registerElement, shouldFocus, children }), $[36] = children, $[37] = handleChildItemClick, $[38] = handleMenuKeyDown, $[39] = menuProps, $[40] = onClickOutside, $[41] = onEscape, $[42] = registerElement, $[43] = shouldFocus, $[44] = t19) : t19 = $[44];
  const childMenu = t19;
  let t20;
  ...
  let t26;
  $[46] !== IconComponent || $[47] !== fontSize2 ? (t26 = IconComponent && (0, import_jsx_runtime12.jsxs)(Text, { size: fontSize2, children: [
    (0, import_react53.isValidElement)(IconComponent) && IconComponent,
    (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime12.jsx)(IconComponent, {})
  ] }), $[46] = IconComponent, $[47] = fontSize2, $[48] = t26) : t26 = $[48];
  let t27;
  $[49] !== fontSize2 || $[50] !== text ? (t27 = (0, import_jsx_runtime12.jsx)(Box, { flex: 1, children: (0, import_jsx_runtime12.jsx)(Text, { size: fontSize2, textOverflow: "ellipsis", weight: "medium", children: text }) }), $[49] = fontSize2, $[50] = text, $[51] = t27) : t27 = $[51];
  let t28;
  $[52] === Symbol.for("react.memo_cache_sentinel") ? (t28 = (0, import_jsx_runtime12.jsx)(ChevronRightIcon, {}), $[52] = t28) : t28 = $[52];
  let t29;
  $[53] !== fontSize2 ? (t29 = (0, import_jsx_runtime12.jsx)(Text, { size: fontSize2, children: t28 }), $[53] = fontSize2, $[54] = t29) : t29 = $[54];
  let t30;
  $[55] !== padding || $[56] !== space || $[57] !== t26 || $[58] !== t27 || $[59] !== t29 ? (t30 = (0, import_jsx_runtime12.jsxs)(Flex, { gap: space, padding, children: [
    t26,
    t27,
    t29
  ] }), $[55] = padding, $[56] = space, $[57] = t26, $[58] = t27, $[59] = t29, $[60] = t30) : t30 = $[60];
  let t31;
  $[61] !== as || $[62] !== handleClick || $[63] !== handleMouseEnter || $[64] !== restProps || $[65] !== scheme || $[66] !== t21 || $[67] !== t22 || $[68] !== t23 || $[69] !== t24 || $[70] !== t25 || $[71] !== t30 || $[72] !== tone ? (t31 = (0, import_jsx_runtime12.jsx)(Selectable, { "data-as": as, "data-ui": "MenuGroup", forwardedAs: as, ...restProps, "aria-pressed": t21, "data-pressed": t22, "data-selected": t23, $radius: t24, $tone: tone, $scheme: scheme, onClick: handleClick, onKeyDown: handleKeyDown, onMouseEnter: handleMouseEnter, ref: setRootElement, tabIndex: -1, type: t25, children: t30 }), $[61] = as, $[62] = handleClick, $[63] = handleMouseEnter, $[64] = restProps, $[65] = scheme, $[66] = t21, $[67] = t22, $[68] = t23, $[69] = t24, $[70] = t25, $[71] = t30, $[72] = tone, $[73] = t31) : t31 = $[73];
  let t32;
  return $[74] !== childMenu || $[75] !== open || $[76] !== popover || $[77] !== t31 ? (t32 = (0, import_jsx_runtime12.jsx)(Popover, { ...popover, content: childMenu, "data-ui": "MenuGroup__popover", open, children: t31 }), $[74] = childMenu, $[75] = open, $[76] = popover, $[77] = t31, $[78] = t32) : t32 = $[78], t32;
}
...
var MenuItem = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  let t6;
  $[23] === Symbol.for("react.memo_cache_sentinel") ? (t6 = () => ref.current, $[23] = t6) : t6 = $[23], (0, import_react53.useImperativeHandle)(forwardedRef, t6);
  let t7, t8;
  $[24] !== mount || $[25] !== rootElement || $[26] !== selectedProp ? (t7 = () => mount(rootElement, selectedProp), t8 = [mount, rootElement, selectedProp], $[24] = mount, $[25] = rootElement, $[26] = selectedProp, $[27] = t7, $[28] = t8) : (t7 = $[27], t8 = $[28]), (0, import_react53.useEffect)(t7, t8);
  let t9;
  ...
  let t21;
  $[44] !== IconComponent || $[45] !== IconRightComponent || $[46] !== fontSize2 || $[47] !== hotkeys || $[48] !== hotkeysFontSize || $[49] !== paddingProps || $[50] !== space || $[51] !== text ? (t21 = (IconComponent || text || IconRightComponent) && (0, import_jsx_runtime12.jsxs)(Flex, { as: "span", gap: space, align: "center", ...paddingProps, children: [
    IconComponent && (0, import_jsx_runtime12.jsxs)(Text, { size: fontSize2, children: [
      (0, import_react53.isValidElement)(IconComponent) && IconComponent,
      (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime12.jsx)(IconComponent, {})
    ] }),
...
var Tab = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  $[0] !== props ? ({
    ...
    selected,
    ...restProps
  } = props, $[0] = props, $[1] = focused, $[2] = icon, $[3] = id3, $[4] = label, $[5] = onClick, $[6] = onFocus, $[7] = restProps, $[8] = selected, $[9] = t0, $[10] = t1) : (focused = $[1], icon = $[2], id3 = $[3], label = $[4], onClick = $[5], onFocus = $[6], restProps = $[7], selected = $[8], t0 = $[9], t1 = $[10]);
  ...
  let t2;
  $[11] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => ref.current, $[11] = t2) : t2 = $[11], (0, import_react53.useImperativeHandle)(forwardedRef, t2);
  let t3;
  ...
  }, t6 = [focused], $[15] = focused, $[16] = t5, $[17] = t6) : (t5 = $[16], t6 = $[17]), (0, import_react53.useEffect)(t5, t6);
  const t7 = selected ? "true" : "false", t8 = selected ? 0 : -1;
  let t9;
  return $[18] !== fontSize2 || $[19] !== handleFocus || $[20] !== icon || $[21] !== id3 || $[22] !== label || $[23] !== onClick || $[24] !== padding || $[25] !== restProps || $[26] !== selected || $[27] !== t7 || $[28] !== t8 ? (t9 = (0, import_jsx_runtime12.jsx)(CustomButton, { "data-ui": "Tab", ...restProps, "aria-selected": t7, fontSize: fontSize2, icon, id: id3, mode: "bleed", onClick, onBlur: handleBlur, onFocus: handleFocus, padding, ref, role: "tab", selected, tabIndex: t8, text: label, type: "button" }), $[18] = fontSize2, $[19] = handleFocus, $[20] = icon, $[21] = id3, $[22] = label, $[23] = onClick, $[24] = padding, $[25] = restProps, $[26] = selected, $[27] = t7, $[28] = t8, $[29] = t9) : t9 = $[29], t9;
});
...
var TabList = (0, import_react53.forwardRef)(function(props, ref) {
  ...
  if ($[3] !== childrenProp || $[4] !== focusedIndex) {
    ...
    let t12;
    $[6] !== focusedIndex ? (t12 = (child, childIndex) => (0, import_react53.cloneElement)(child, {
  ...
  let t2;
  return $[10] !== handleKeyDown || $[11] !== ref || $[12] !== restProps || $[13] !== tabs ? (t2 = (0, import_jsx_runtime12.jsx)(CustomInline, { "data-ui": "TabList", ...restProps, onKeyDown: handleKeyDown, ref, role: "tablist", children: tabs }), $[10] = handleKeyDown, $[11] = ref, $[12] = restProps, $[13] = tabs, $[14] = t2) : t2 = $[14], t2;
});
...
function useClickOutside(listener, t0, boundaryElement) {
  const $ = (0, import_react_compiler_runtime2.c)(12), elementsArg = t0 === void 0 ? EMPTY_ARRAY : t0, [element, setElement] = (0, import_react55.useState)(null);
  let t1;
  $[0] !== element || $[1] !== elementsArg ? (t1 = () => _getElements(element, elementsArg), $[0] = element, $[1] = elementsArg, $[2] = t1) : t1 = $[2];
  const [elements, setElements] = (0, import_react55.useState)(t1), elementsRef = (0, import_react55.useRef)(elements);
  let t2, t3;
  ...
  }, t3 = [element, elementsArg], $[3] = element, $[4] = elementsArg, $[5] = t2, $[6] = t3) : (t2 = $[5], t3 = $[6]), (0, import_react55.useEffect)(t2, t3);
  let t4, t5;
  ...
  }, t5 = [boundaryElement, listener, elements], $[7] = boundaryElement, $[8] = elements, $[9] = listener, $[10] = t4, $[11] = t5) : (t4 = $[10], t5 = $[11]), (0, import_react55.useEffect)(t4, t5), setElement;
}
...
function useForwardedRef(ref) {
  const $ = (0, import_react_compiler_runtime2.c)(1), innerRef = (0, import_react55.useRef)(null);
  let t0;
  return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => innerRef.current, $[0] = t0) : t0 = $[0], (0, import_react55.useImperativeHandle)(ref, t0), innerRef;
}
...
function AutocompleteOption(props) {
  ...
  const handleKeyDown = t1;
  let t2;
  return $[5] !== children || $[6] !== handleClick || $[7] !== handleKeyDown || $[8] !== id3 || $[9] !== selected ? (t2 = (0, import_jsx_runtime13.jsx)("li", { "aria-selected": selected, "data-ui": "AutocompleteOption", id: id3, role: "option", onClick: handleClick, onKeyDown: handleKeyDown, children }), $[5] = children, $[6] = handleClick, $[7] = handleKeyDown, $[8] = id3, $[9] = selected, $[10] = t2) : t2 = $[10], t2;
}
...
var InnerAutocomplete = (0, import_react55.forwardRef)(function(props, forwardedRef) {
  ...
  }, []), handleOptionSelect = (0, import_react55.useCallback)((v) => {
    var _a;
    dispatch({
      type: "value/change",
      value: v
...
var Breadcrumbs = (0, import_react55.forwardRef)(function(props, ref) {
  ...
  let t1;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => setOpen(false), $[6] = t1) : t1 = $[6];
  const collapse = t1;
  let t2;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => setOpen(true), $[7] = t2) : t2 = $[7];
  const expand = t2;
  let t3;
  ...
  let t4;
  $[9] !== children ? (t4 = import_react55.Children.toArray(children).filter(import_react55.isValidElement), $[9] = children, $[10] = t4) : t4 = $[10];
  const rawItems = t4;
  let t5;
  bb0: {
    ...
    if (maxLength && len > maxLength) {
      ...
      if ($[11] !== afterLength || $[12] !== beforeLength || $[13] !== len || $[14] !== open || $[15] !== rawItems || $[16] !== space) {
        ...
        let t9;
        $[23] !== space || $[24] !== t8 ? (t9 = (0, import_jsx_runtime13.jsx)(Stack, { as: "ol", overflow: "auto", padding: space, space, children: t8 }), $[23] = space, $[24] = t8, $[25] = t9) : t9 = $[25];
        const t10 = open ? collapse : expand;
        let t11;
        $[26] !== open || $[27] !== t10 ? (t11 = (0, import_jsx_runtime13.jsx)(ExpandButton, { fontSize: 1, mode: "bleed", onClick: t10, padding: 1, ref: expandElementRef, selected: open, text: "…" }), $[26] = open, $[27] = t10, $[28] = t11) : t11 = $[28];
        let t12;
        $[29] !== open || $[30] !== t11 || $[31] !== t9 ? (t12 = (0, import_jsx_runtime13.jsx)(Popover, { constrainSize: true, content: t9, open, placement: "top", portal: true, ref: popoverElementRef, children: t11 }, "button"), $[29] = open, $[30] = t11, $[31] = t9, $[32] = t12) : t12 = $[32], t62 = [...t72, t12, ...rawItems.slice(len - afterLength)], $[11] = afterLength, $[12] = beforeLength, $[13] = len, $[14] = open, $[15] = rawItems, $[16] = space, $[17] = t62;
      } else
        t62 = $[17];
      t5 = t62;
      break bb0;
  ...
  if ($[33] !== items || $[34] !== separator || $[35] !== space) {
    let t72;
    $[37] !== separator || $[38] !== space ? (t72 = (item, itemIndex) => (0, import_jsx_runtime13.jsxs)(import_react55.Fragment, { children: [
    ...
    t6 = $[36];
  let t7;
  return $[40] !== ref || $[41] !== restProps || $[42] !== t6 ? (t7 = (0, import_jsx_runtime13.jsx)(StyledBreadcrumbs, { "data-ui": "Breadcrumbs", ...restProps, ref, children: t6 }), $[40] = ref, $[41] = restProps, $[42] = t6, $[43] = t7) : t7 = $[43], t7;
});
...
var StyledDialog = gt(Layer).withConfig({
...
var DialogCard = (0, import_react55.forwardRef)(function(props, forwardedRef) {
  ...
  let t0;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $[0] = t0) : t0 = $[0], (0, import_react55.useImperativeHandle)(forwardedRef, t0);
  let t1;
  $[1] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => contentRef.current, $[1] = t1) : t1 = $[1], (0, import_react55.useImperativeHandle)(forwardedContentRef, t1);
  let t2, t3;
  $[2] !== autoFocus ? (t2 = () => {
    autoFocus && ref.current && focusFirstDescendant(ref.current);
  }, t3 = [autoFocus, ref], $[2] = autoFocus, $[3] = t2, $[4] = t3) : (t2 = $[3], t3 = $[4]), (0, import_react55.useEffect)(t2, t3);
  let t4;
  ...
  let t7;
  $[16] !== header || $[17] !== labelId || $[18] !== onClose || $[19] !== showCloseButton || $[20] !== showHeader ? (t7 = showHeader && (0, import_jsx_runtime13.jsx)(DialogHeader, { children: (0, import_jsx_runtime13.jsxs)(Flex, { align: "flex-start", padding: 3, children: [
  ...
  let t8;
  $[22] !== children ? (t8 = (0, import_jsx_runtime13.jsx)(DialogContent, { flex: 1, ref: contentRef, tabIndex: -1, children }), $[22] = children, $[23] = t8) : t8 = $[23];
  let t9;
  $[24] !== footer ? (t9 = footer && (0, import_jsx_runtime13.jsx)(DialogFooter, { children: footer }), $[24] = footer, $[25] = t9) : t9 = $[25];
  let t10;
  $[26] !== t7 || $[27] !== t8 || $[28] !== t9 ? (t10 = (0, import_jsx_runtime13.jsxs)(DialogLayout, { direction: "column", children: [
    t7,
    t8,
    t9
  ] }), $[26] = t7, $[27] = t8, $[28] = t9, $[29] = t10) : t10 = $[29];
  let t11;
  $[30] !== radius || $[31] !== scheme || $[32] !== shadow || $[33] !== t10 ? (t11 = (0, import_jsx_runtime13.jsx)(DialogCardRoot, { radius, ref, scheme, shadow, children: t10 }), $[30] = radius, $[31] = scheme, $[32] = shadow, $[33] = t10, $[34] = t11) : t11 = $[34];
  let t12;
  return $[35] !== t11 || $[36] !== width ? (t12 = (0, import_jsx_runtime13.jsx)(DialogContainer, { "data-ui": "DialogCard", width, children: t11 }), $[35] = t11, $[36] = width, $[37] = t12) : t12 = $[37], t12;
});
...
var Dialog = (0, import_react55.forwardRef)(function(props, ref) {
  ...
  let t9;
  $[27] === Symbol.for("react.memo_cache_sentinel") ? (t9 = (0, import_jsx_runtime13.jsx)("div", { ref: preDivRef, tabIndex: 0 }), $[27] = t9) : t9 = $[27];
  let t10;
  $[28] !== autoFocus || $[29] !== cardRadius || $[30] !== cardShadow || $[31] !== children || $[32] !== contentRef || $[33] !== footer || $[34] !== header || $[35] !== hideCloseButton || $[36] !== id3 || $[37] !== onClickOutside || $[38] !== onClose || $[39] !== portalProp || $[40] !== scheme || $[41] !== width ? (t10 = (0, import_jsx_runtime13.jsx)(DialogCard, { __unstable_autoFocus: autoFocus, __unstable_hideCloseButton: hideCloseButton, contentRef, footer, header, id: id3, onClickOutside, onClose, portal: portalProp, radius: cardRadius, ref: cardRef, scheme, shadow: cardShadow, width, children }), $[28] = autoFocus, $[29] = cardRadius, $[30] = cardShadow, $[31] = children, $[32] = contentRef, $[33] = footer, $[34] = header, $[35] = hideCloseButton, $[36] = id3, $[37] = onClickOutside, $[38] = onClose, $[39] = portalProp, $[40] = scheme, $[41] = width, $[42] = t10) : t10 = $[42];
  let t11;
  $[43] === Symbol.for("react.memo_cache_sentinel") ? (t11 = (0, import_jsx_runtime13.jsx)("div", { ref: postDivRef, tabIndex: 0 }), $[43] = t11) : t11 = $[43];
  let t12;
  $[44] !== animate2 || $[45] !== handleFocus || $[46] !== handleRootClick || $[47] !== id3 || $[48] !== labelId || $[49] !== onActivate || $[50] !== padding || $[51] !== position || $[52] !== ref || $[53] !== restProps || $[54] !== t10 || $[55] !== zOffset ? (t12 = (0, import_jsx_runtime13.jsxs)(StyledDialog, { ...restProps, $animate: animate2, $padding: padding, $position: position, "aria-labelledby": labelId, "aria-modal": true, "data-ui": "Dialog", id: id3, onActivate, onClick: handleRootClick, onFocus: handleFocus, ref, role: "dialog", zOffset, children: [
    t9,
    t10,
    t11
  ] }), $[44] = animate2, $[45] = handleFocus, $[46] = handleRootClick, $[47] = id3, $[48] = labelId, $[49] = onActivate, $[50] = padding, $[51] = position, $[52] = ref, $[53] = restProps, $[54] = t10, $[55] = zOffset, $[56] = t12) : t12 = $[56];
  let t13;
  return $[57] !== portalProp || $[58] !== t12 ? (t13 = (0, import_jsx_runtime13.jsx)(Portal, { __unstable_name: portalProp, children: t12 }), $[57] = portalProp, $[58] = t12, $[59] = t13) : t13 = $[59], t13;
});
...
function DialogProvider(props) {
  ...
  let t1;
  return $[3] !== children || $[4] !== contextValue ? (t1 = (0, import_jsx_runtime13.jsx)(DialogContext.Provider, { value: contextValue, children }), $[3] = children, $[4] = contextValue, $[5] = t1) : t1 = $[5], t1;
}
...
var MenuButton = (0, import_react55.forwardRef)(function(props, forwardedRef) {
  ...
  }, t4 = [onOpen, open], $[1] = onOpen, $[2] = open, $[3] = t3, $[4] = t4) : (t3 = $[3], t4 = $[4]), (0, import_react55.useEffect)(t3, t4);
  let t5, t6;
  $[5] !== onClose || $[6] !== open ? (t5 = () => {
    onClose && !open && openRef.current && onClose();
  }, t6 = [onClose, open], $[5] = onClose, $[6] = open, $[7] = t5, $[8] = t6) : (t5 = $[7], t6 = $[8]), (0, import_react55.useEffect)(t5, t6);
  let t7, t8;
  $[9] !== open ? (t7 = () => {
    openRef.current = open;
  }, t8 = [open], $[9] = open, $[10] = t7, $[11] = t8) : (t7 = $[10], t8 = $[11]), (0, import_react55.useEffect)(t7, t8);
  let t9;
  ...
  let t17;
  $[28] !== buttonElement || $[29] !== handleBlur || $[30] !== handleItemClick || $[31] !== handleMenuClickOutside || $[32] !== handleMenuEscape || $[33] !== id3 || $[34] !== menuProp || $[35] !== shouldFocus ? (t17 = menuProp && (0, import_react55.cloneElement)(menuProp, {
    "aria-labelledby": id3,
    ...
    registerElement,
    shouldFocus
  }), $[28] = buttonElement, $[29] = handleBlur, $[30] = handleItemClick, $[31] = handleMenuClickOutside, $[32] = handleMenuEscape, $[33] = id3, $[34] = menuProp, $[35] = shouldFocus, $[36] = t17) : t17 = $[36];
  const menu = t17;
  let t18;
  $[37] !== buttonProp || $[38] !== handleMouseDown || $[39] !== id3 || $[40] !== open ? (t18 = buttonProp && (0, import_react55.cloneElement)(buttonProp, {
    "data-ui": "MenuButton",
    id: id3,
  ...
  }), $[37] = buttonProp, $[38] = handleMouseDown, $[39] = id3, $[40] = open, $[41] = t18) : t18 = $[41];
  const button = t18;
  let t19, t20;
  $[42] !== buttonElement ? (t19 = () => buttonElement, t20 = [buttonElement], $[42] = buttonElement, $[43] = t19, $[44] = t20) : (t19 = $[43], t20 = $[44]), (0, import_react55.useImperativeHandle)(forwardedRef, t19, t20);
  let t21;
  ...
  let t23;
  $[55] !== button ? (t23 = button || (0, import_jsx_runtime13.jsx)(import_jsx_runtime13.Fragment, {}), $[55] = button, $[56] = t23) : t23 = $[56];
  let t24;
  return $[57] !== menu || $[58] !== open || $[59] !== popoverProps || $[60] !== t23 ? (t24 = (0, import_jsx_runtime13.jsx)(Popover, { "data-ui": "MenuButton__popover", ...popoverProps, content: menu, open, children: t23 }), $[57] = menu, $[58] = open, $[59] = popoverProps, $[60] = t23, $[61] = t24) : t24 = $[61], t24;
});
...
`;
var StyledSkeleton$1 = gt(Box).withConfig({
...
var Skeleton = (0, import_react55.forwardRef)(function(props, ref) {
  ...
  }, t2 = [delay2], $[5] = delay2, $[6] = t1, $[7] = t2) : (t1 = $[6], t2 = $[7]), (0, import_react55.useEffect)(t1, t2);
  const t3 = useArrayProp(radius);
  let t4;
  return $[8] !== animated || $[9] !== ref || $[10] !== restProps || $[11] !== t3 || $[12] !== visible ? (t4 = (0, import_jsx_runtime13.jsx)(StyledSkeleton$1, { ...restProps, $animated: animated, $radius: t3, $visible: visible, ref }), $[8] = animated, $[9] = ref, $[10] = restProps, $[11] = t3, $[12] = visible, $[13] = t4) : t4 = $[13], t4;
});
Skeleton.displayName = "ForwardRef(Skeleton)";
var StyledSkeleton = gt(Skeleton).withConfig({
  displayName: "StyledSkeleton",
...
var TextSkeleton = (0, import_react55.forwardRef)(function(props, ref) {
  ...
  let t1;
  return $[3] !== $size || $[4] !== ref || $[5] !== restProps ? (t1 = (0, import_jsx_runtime13.jsx)(StyledSkeleton, { ...restProps, $size, ref, $style: "text" }), $[3] = $size, $[4] = ref, $[5] = restProps, $[6] = t1) : t1 = $[6], t1;
});
...
var LabelSkeleton = (0, import_react55.forwardRef)(function(props, ref) {
  ...
  const $size = useArrayProp(t0 === void 0 ? 2 : t0);
  let t1;
  return $[3] !== $size || $[4] !== ref || $[5] !== restProps ? (t1 = (0, import_jsx_runtime13.jsx)(StyledSkeleton, { ...restProps, $size, ref, $style: "label" }), $[3] = $size, $[4] = ref, $[5] = restProps, $[6] = t1) : t1 = $[6], t1;
});
...
var HeadingSkeleton = (0, import_react55.forwardRef)(function(props, ref) {
  ...
  const $size = useArrayProp(t0 === void 0 ? 2 : t0);
  let t1;
  return $[3] !== $size || $[4] !== ref || $[5] !== restProps ? (t1 = (0, import_jsx_runtime13.jsx)(StyledSkeleton, { ...restProps, $size, ref, $style: "heading" }), $[3] = $size, $[4] = ref, $[5] = restProps, $[6] = t1) : t1 = $[6], t1;
});
...
var CodeSkeleton = (0, import_react55.forwardRef)(function(props, ref) {
  ...
  const $size = useArrayProp(t0 === void 0 ? 2 : t0);
  let t1;
  return $[3] !== $size || $[4] !== ref || $[5] !== restProps ? (t1 = (0, import_jsx_runtime13.jsx)(StyledSkeleton, { ...restProps, $size, ref, $style: "code" }), $[3] = $size, $[4] = ref, $[5] = restProps, $[6] = t1) : t1 = $[6], t1;
});
...
var TabPanel = (0, import_react55.forwardRef)(function(props, ref) {
  ...
  let t1;
  return $[3] !== flex || $[4] !== props.children || $[5] !== ref || $[6] !== restProps || $[7] !== t0 ? (t1 = (0, import_jsx_runtime13.jsx)(Box, { "data-ui": "TabPanel", ...restProps, flex, ref, role: "tabpanel", tabIndex: t0, children: props.children }), $[3] = flex, $[4] = props.children, $[5] = ref, $[6] = restProps, $[7] = t0, $[8] = t1) : t1 = $[8], t1;
});
...
function Toast(props) {
  ...
  let t6;
  $[15] !== title ? (t6 = title && (0, import_jsx_runtime13.jsx)(Text, { size: 1, weight: "medium", children: title }), $[15] = title, $[16] = t6) : t6 = $[16];
  let t7;
  $[17] !== description || $[18] !== transition ? (t7 = description && (0, import_jsx_runtime13.jsx)(MotionText, { muted: true, size: 1, variants: content, transition, children: description }), $[17] = description, $[18] = transition, $[19] = t7) : t7 = $[19];
  let t8;
  $[20] !== t6 || $[21] !== t7 ? (t8 = (0, import_jsx_runtime13.jsx)(TextBox, { flex: 1, padding: 3, children: (0, import_jsx_runtime13.jsxs)(Stack, { space: 3, children: [
    t6,
    t7
  ] }) }), $[20] = t6, $[21] = t7, $[22] = t8) : t8 = $[22];
  let t9;
  $[23] !== buttonTone || $[24] !== closable || $[25] !== onClose ? (t9 = closable && (0, import_jsx_runtime13.jsx)(Box, { padding: 1, children: (0, import_jsx_runtime13.jsx)(Button, { as: "button", icon: CloseIcon, mode: "bleed", padding: 2, tone: buttonTone, onClick: onClose, style: {
    verticalAlign: "top"
  } }) }), $[23] = buttonTone, $[24] = closable, $[25] = onClose, $[26] = t9) : t9 = $[26];
  let t10;
  $[27] !== t8 || $[28] !== t9 || $[29] !== transition ? (t10 = (0, import_jsx_runtime13.jsxs)(MotionFlex2, { align: "flex-start", variants: content, transition, children: [
    t8,
    t9
  ] }), $[27] = t8, $[28] = t9, $[29] = transition, $[30] = t10) : t10 = $[30];
  let t11;
  $[31] !== cardTone || $[32] !== duration || $[33] !== hasDuration || $[34] !== onClose || $[35] !== radius || $[36] !== transition || $[37] !== updatedAt || $[38] !== visualDuration ? (t11 = hasDuration && (0, import_jsx_runtime13.jsxs)(MotionLoadingBar, { variants: content, transition, children: [
  ...
  let t12;
  return $[40] !== cardTone || $[41] !== radius || $[42] !== restProps || $[43] !== role || $[44] !== t10 || $[45] !== t11 || $[46] !== t5 || $[47] !== transition || $[48] !== visualDuration ? (t12 = (0, import_jsx_runtime13.jsxs)(MotionToast, { "data-ui": "Toast", role, ...restProps, "data-has-duration": t5, custom: visualDuration, radius, shadow: 2, tone: cardTone, forwardedAs: "li", layout: "position", variants: container, initial, animate: animate2, exit, transition, children: [
    t10,
    t11
...
function ToastLayer(props) {
  ...
  let t3;
  return $[2] !== children || $[3] !== gap || $[4] !== padding || $[5] !== paddingX || $[6] !== paddingY || $[7] !== t2 ? (t3 = (0, import_jsx_runtime13.jsx)(StyledLayer2, { forwardedAs: "ul", "data-ui": "ToastProvider", padding, paddingX, paddingY, gap, columns: 1, style: t2, children }), $[2] = children, $[3] = gap, $[4] = padding, $[5] = paddingX, $[6] = paddingY, $[7] = t2, $[8] = t3) : t3 = $[8], t3;
}
ToastLayer.displayName = "ToastLayer";
var StyledLayer2 = gt(Grid).withConfig({
  displayName: "StyledLayer",
...
function ToastProvider(props) {
  ...
  const value = t2;
  let t3;
  $[2] !== gap || $[3] !== mounted || $[4] !== padding || $[5] !== paddingX || $[6] !== paddingY || $[7] !== state || $[8] !== zOffset ? (t3 = mounted && (0, import_jsx_runtime13.jsx)(LayerProvider, { zOffset, children: (0, import_jsx_runtime13.jsx)(ToastLayer, { padding, paddingX, paddingY, gap, children: (0, import_jsx_runtime13.jsx)(AnimatePresence, { initial: false, mode: "popLayout", children: state.map(_temp4) }) }) }), $[2] = gap, $[3] = mounted, $[4] = padding, $[5] = paddingX, $[6] = paddingY, $[7] = state, $[8] = zOffset, $[9] = t3) : t3 = $[9];
  let t4;
  return $[10] !== children || $[11] !== t3 ? (t4 = (0, import_jsx_runtime13.jsxs)(ToastContext.Provider, { value, children: [
    children,
    t3
...
var Tree = (0, import_react55.memo)((0, import_react55.forwardRef)(function(props, forwardedRef) {
  ...
  let t4;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref.current, $[8] = t4) : t4 = $[8], (0, import_react55.useImperativeHandle)(forwardedRef, t4);
  let t5, t6;
  $[9] !== focusedElement ? (t5 = () => {
    focusedElementRef.current = focusedElement;
  }, t6 = [focusedElement], $[9] = focusedElement, $[10] = t5, $[11] = t6) : (t5 = $[10], t6 = $[11]), (0, import_react55.useEffect)(t5, t6);
  let t7, t8;
  $[12] !== state ? (t7 = () => {
    stateRef.current = state;
  }, t8 = [state], $[12] = state, $[13] = t7, $[14] = t8) : (t7 = $[13], t8 = $[14]), (0, import_react55.useEffect)(t7, t8);
  let t9;
  ...
  let t16;
  $[26] !== children ? (t16 = [children], $[26] = children, $[27] = t16) : t16 = $[27], (0, import_react55.useEffect)(t15, t16);
  let t17;
  $[28] !== children || $[29] !== handleFocus || $[30] !== handleKeyDown || $[31] !== restProps || $[32] !== space ? (t17 = (0, import_jsx_runtime13.jsx)(Stack, { as: "ul", "data-ui": "Tree", ...restProps, onFocus: handleFocus, onKeyDown: handleKeyDown, ref, role: "tree", space, children }), $[28] = children, $[29] = handleFocus, $[30] = handleKeyDown, $[31] = restProps, $[32] = space, $[33] = t17) : t17 = $[33];
  let t18;
  return $[34] !== contextValue || $[35] !== t17 ? (t18 = (0, import_jsx_runtime13.jsx)(TreeContext.Provider, { value: contextValue, children: t17 }), $[34] = contextValue, $[35] = t17, $[36] = t18) : t18 = $[36], t18;
}));
...
var TreeGroup = (0, import_react55.memo)(function(props) {
  ...
  let t2;
  return $[4] !== children || $[5] !== restProps || $[6] !== t1 || $[7] !== tree.space ? (t2 = (0, import_jsx_runtime13.jsx)(Stack, { as: "ul", "data-ui": "TreeGroup", ...restProps, hidden: t1, marginTop: tree.space, role: "group", space: tree.space, children }), $[4] = children, $[5] = restProps, $[6] = t1, $[7] = tree.space, $[8] = t2) : t2 = $[8], t2;
});
var StyledTreeItem = (0, import_react55.memo)(gt.li.withConfig({
  displayName: "StyledTreeItem",
  componentId: "sc-iiskig-0"
})(treeItemRootStyle, treeItemRootColorStyle));
var TreeItemBox = gt(Box).attrs({
  forwardedAs: "a"
}).withConfig({
...
//# sourceMappingURL=chunk-5OQO2VVF.js.map
