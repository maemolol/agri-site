...
import {
  ...
  throwError,
  timer
} from "./chunk-O3ND4YU3.js";
import "./chunk-K2PCTGOD.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-Q3VGEFAL.js").then(function(n) {
...
var eventSourcePolyfill = defer(() => import("./browser-DIHLRIBM.js")).pipe(
...
var _ObservableSanityClient = class _ObservableSanityClient {
  constructor(httpRequest, config = defaultConfig) {
    ...
    this.config(config), __privateSet(this, _httpRequest9, httpRequest), this.assets = new ObservableAssetsClient(this, __privateGet(this, _httpRequest9)), this.datasets = new ObservableDatasetsClient(this, __privateGet(this, _httpRequest9)), this.live = new LiveClient(this), this.projects = new ObservableProjectsClient(this, __privateGet(this, _httpRequest9)), this.users = new ObservableUsersClient(this, __privateGet(this, _httpRequest9));
  }
  /**
...
var _SanityClient = class _SanityClient {
  constructor(httpRequest, config = defaultConfig) {
     ...
     */
    __publicField(this, "listen", _listen);
    this.config(config), __privateSet(this, _httpRequest10, httpRequest), this.assets = new AssetsClient(this, __privateGet(this, _httpRequest10)), this.datasets = new DatasetsClient(this, __privateGet(this, _httpRequest10)), this.live = new LiveClient(this), this.projects = new ProjectsClient(this, __privateGet(this, _httpRequest10)), this.users = new UsersClient(this, __privateGet(this, _httpRequest10)), this.observable = new ObservableSanityClient(httpRequest, config);
  }
  /**
   * Clone the client - returns a new instance
   */
