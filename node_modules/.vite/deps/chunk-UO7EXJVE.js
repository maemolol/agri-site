...
var init_node_entry = __esm({
  "node_modules/rollup/dist/es/shared/node-entry.js"() {
    ...
    promises = __toESM(require_promises(), 1);
    version = "4.59.0";
    comma = ",".charCodeAt(0);
    ...
    UnknownWellKnown = Symbol("Unknown Well-Known");
    SymbolToStringTag = Symbol("Symbol.toStringTag");
    SymbolDispose = Symbol("Symbol.asyncDispose");
    SymbolAsyncDispose = Symbol("Symbol.dispose");
    ...
    isInteger = (property2) => typeof property2 === "string" && /^\d+$/.test(property2);
    ...
    MAX_PATH_DEPTH = 6;
    limitConcatenatedPathDepth = (path1, path2) => {
    ...
    getResolveUrl = (path, asObject, URL2 = "URL") => `new ${URL2}(${path})${asObject ? "" : ".href"}`;
    ...
    getGenericImportMetaMechanism = (getUrl) => (property2, { chunkId }) => {
      const urlMechanism = getUrl(chunkId);
      return property2 === null ? `({ url: ${urlMechanism} })` : property2 === "url" ? urlMechanism : "undefined";
    };
    getFileUrlFromFullPath = (path, asObject) => `require('u' + 'rl').pathToFileURL(${path})${asObject ? "" : ".href"}`;
    getFileUrlFromRelativePath = (path, asObject) => getFileUrlFromFullPath(`__dirname + '/${escapeId(path)}'`, asObject);
    ...
    utils = {};
    picomatchExports = requirePicomatch();
    picomatch = getDefaultExportFromCjs(picomatchExports);
    extractors = {
    ...
    createFilter$1 = function createFilter(include, exclude, options) {
    ...
    UNASSIGNED$1 = Symbol("Unassigned");
    ...
    PanicError = class extends NodeBase {
      initialise() {
    ...
    ParseError = class extends NodeBase {
      initialise() {
...
`);
    ...
    getHash64 = (input) => (0, import_native.xxhashBase64Url)(ensureBuffer(input));
    getHash36 = (input) => (0, import_native.xxhashBase36)(ensureBuffer(input));
    getHash16 = (input) => (0, import_native.xxhashBase16)(ensureBuffer(input));
    hasherByType = {
      base36: getHash36,
      base64: getHash64,
      hex: getHash16
    ...
    picocolors = { exports: {} };
    picocolorsExports = requirePicocolors();
    pc = getDefaultExportFromCjs(picocolorsExports);
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-UO7EXJVE.js.map
